...
Per-component base stylesheets used by angulux.
...
Forked from `@primeuix/styles`, MIT, at the final public commit of
[primefaces/primeuix](https://github.com/primefaces/primeuix) (`b9467bc`, repository
archived 2026-06-28\), which published as `@primeuix/styles 2.0.3`.
