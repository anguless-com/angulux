...
@Component({
    ...
    standalone: false,
    template: `
        <agl-menu #menu [model]="popupItems" [popup]="true"></agl-menu>
...
@Component({
    ...
    template: ` <agl-menu [model]="routerModel"></agl-menu> `
})
...
@Component({
    ...
    template: ` <agl-menu [model]="submenuModel"></agl-menu> `
})
...
@Component({
    ...
    template: ` <agl-menu [model]="disabledModel"></agl-menu> `
})
...
@Component({
    ...
    template: ` <agl-menu [model]="model" [styleClass]="customStyleClass" [style]="customStyle"></agl-menu> `
})
...
@Component({
    ...
    template: ` <agl-menu [model]="dynamicModel"></agl-menu> `
})
...
@Component({
    ...
    template: ` <agl-menu [model]="commandModel"></agl-menu> `
})
...
describe('Menu', () => {
    ...
    beforeEach(async () => {
        await TestBed.configureTestingModule({
            ...
            providers: [
                ...
                OverlayService,
                // Angular 22: `RouterTestingModule` is deprecated and no longer provides
                // `ActivatedRoute` at the root injector, so `routerLink` inside a menu item
                // throws NG0201. `provideRouter` is the supported replacement.
                provideRouter([
                    { path: '', component: TestTargetComponent },
                    { path: 'products', component: TestTargetComponent },
                    { path: 'services', component: TestTargetComponent }
    ...
    describe('PassThrough (PT)', () => {
        ...
        describe('Case 6: Inline test', () => {
            it('should apply inline PT with string class', () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [Menu],
                    template: `<agl-menu [pt]="{ root: 'INLINE_ROOT_CLASS' }"></agl-menu>`
                })
            ...
            it('should apply inline PT with object class', () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [Menu],
                    template: `<agl-menu [pt]="{ root: { class: 'INLINE_OBJECT_CLASS' } }"></agl-menu>`
                })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            ...
            it('should apply global PT configuration from AnguluxConfig config', () => {
            ...
            it('should merge local PT with global PT', () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [Menu],
                    template: `<agl-menu [pt]="{ root: { class: 'LOCAL_CLASS' } }"></agl-menu>`
                })
