...
@Component({
    ...
    standalone: false,
    template: ` <agl-tag [value]="value" [icon]="icon" [severity]="severity" [rounded]="rounded" [styleClass]="styleClass"> </agl-tag> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-tag value="Icon Tag" icon="pi pi-check"></agl-tag> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-tag value="Success Tag" severity="success" icon="pi pi-check" [rounded]="true"> </agl-tag> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-tag [value]="value" [severity]="severity" [style]="style" [styleClass]="styleClass"> </agl-tag> `
})
...
describe('Tag', () => {
    ...
    describe('PassThrough API', () => {
        @Component({
            ...
            standalone: true,
            imports: [Tag],
            template: `<agl-tag [value]="value()" [icon]="icon()" [severity]="severity()" [rounded]="rounded()" [pt]="pt()"></agl-tag>`
        })
        ...
        beforeEach(() => {
            ...
            fixture.detectChanges();
            tagElement = fixture.debugElement.query(By.css('agl-tag'));
        });
