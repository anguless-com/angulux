...
@Component({
    ...
    template: `<agl-skeleton [shape]="shape" [animation]="animation" [width]="width" [height]="height"></agl-skeleton>`
})
...
@Component({
    ...
    template: ` <agl-skeleton [shape]="shape" [size]="size" [borderRadius]="borderRadius" [animation]="animation"> </agl-skeleton> `
})
...
@Component({
    ...
    template: ` <agl-skeleton [width]="width" [height]="height" [size]="size" [shape]="shape"> </agl-skeleton> `
})
...
@Component({
    ...
    template: ` <agl-skeleton [animation]="animation" [shape]="shape"> </agl-skeleton> `
})
...
@Component({
    ...
    template: ` <agl-skeleton [styleClass]="styleClass" [shape]="shape" [borderRadius]="borderRadius"> </agl-skeleton> `
})
...
@Component({
    ...
    template: `
        <div class="card-skeleton">
            <agl-skeleton shape="circle" size="4rem"></agl-skeleton>
            <div class="content">
                <agl-skeleton width="10rem" styleClass="mb-2"></agl-skeleton>
                <agl-skeleton width="8rem" styleClass="mb-2"></agl-skeleton>
                <agl-skeleton height="0.5rem" styleClass="mb-2"></agl-skeleton>
            </div>
        </div>
    `
})
    ...
    template: `
        <div class="table-skeleton">
            <div class="table-header">
                <agl-skeleton width="100%" height="2rem" styleClass="mb-2"></agl-skeleton>
            </div>
            <div class="table-rows">
                <div *ngFor="let row of rows; trackBy: trackByFn" class="table-row">
                    <agl-skeleton width="25%" height="1.5rem" styleClass="mr-2"></agl-skeleton>
                    <agl-skeleton width="25%" height="1.5rem" styleClass="mr-2"></agl-skeleton>
                    <agl-skeleton width="25%" height="1.5rem" styleClass="mr-2"></agl-skeleton>
                    <agl-skeleton width="25%" height="1.5rem"></agl-skeleton>
                </div>
            </div>
        </div>
    `
...
@Component({
    ...
    template: `<agl-skeleton></agl-skeleton>`
})
...
@Component({
    ...
    template: ` <agl-skeleton [shape]="dynamicShape" [animation]="dynamicAnimation" [width]="dynamicWidth" [height]="dynamicHeight" [size]="dynamicSize" [borderRadius]="dynamicBorderRadius" [styleClass]="dynamicStyleClass"> </agl-skeleton> `
})
...
describe('Skeleton', () => {
            ...
            @Component({
                ...
                template: `
                    <div *ngFor="let item of items; trackBy: trackByFn">
                        <agl-skeleton [width]="item.width" [height]="item.height"></agl-skeleton>
                    </div>
                `
            })
        ...
        it('should handle nested skeleton layouts', () => {
            @Component({
                ...
                template: `
                    <div class="container">
                        <div class="header">
                            <agl-skeleton shape="circle" size="3rem"></agl-skeleton>
                            <div class="header-content">
                                <agl-skeleton width="8rem" height="1.5rem"></agl-skeleton>
                                <agl-skeleton width="6rem" height="1rem"></agl-skeleton>
                            </div>
                        </div>
                        <div class="body">
                            <agl-skeleton width="100%" height="10rem"></agl-skeleton>
                        </div>
                        <div class="footer">
                            <agl-skeleton width="4rem" height="2rem" styleClass="mr-2"></agl-skeleton>
                            <agl-skeleton width="4rem" height="2rem"></agl-skeleton>
                        </div>
                    </div>
                `
            })
            ...
            @Component({
                ...
                template: `
                    <div *ngIf="showSkeletons">
                        <agl-skeleton *ngFor="let item of skeletonItems" [width]="item.width" [height]="item.height" [shape]="item.shape"> </agl-skeleton>
                    </div>
                `
            })
    ...
    describe('PassThrough - Case 1: Simple string classes', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-skeleton [pt]="pt"></agl-skeleton> `
        })
    ...
    describe('PassThrough - Case 4: Use variables from instance', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-skeleton [shape]="shape" [animation]="animation" [pt]="pt"></agl-skeleton> `
        })
    ...
    describe('PassThrough - Case 6: Inline test', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-skeleton [pt]="{ host: 'INLINE_HOST_CLASS' }"></agl-skeleton> `
        })
        ...
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-skeleton [pt]="{ host: { class: 'INLINE_OBJECT_CLASS', style: { border: '2px solid green' } } }"></agl-skeleton> `
        })
    ...
    describe('PassThrough - Case 7: Test from AnguluxConfig', () => {
        ...
        it('should merge local pt with global pt configuration', () => {
            ...
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: ` <agl-skeleton [pt]="{ host: 'LOCAL_HOST_CLASS', root: 'LOCAL_ROOT_CLASS' }"></agl-skeleton> `
            })
