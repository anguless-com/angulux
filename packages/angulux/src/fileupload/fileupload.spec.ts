...
import { MessageService } from 'angulux/api';
...
describe('FileUpload Template Tests', () => {
    ...
    describe('aglTemplate Tests', () => {
        ...
        it('should render aglTemplate="filelabel" in basic mode', async () => {
            await TestBed.configureTestingModule({
                imports: [FileUpload, HttpClientTestingModule],
        ...
        it('should render aglTemplate icons', async () => {
            await TestBed.configureTestingModule({
                imports: [FileUpload, HttpClientTestingModule],
        ...
        it('should render aglTemplate="toolbar"', async () => {
            await TestBed.configureTestingModule({
                imports: [FileUpload, HttpClientTestingModule],
    ...
    describe('PT (PassThrough) Tests', () => {
        describe('Case 1: Simple string classes', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-fileupload [pt]="pt" name="test" url="./upload"></agl-fileupload>`
            })
        ...
        describe('Case 4: Use variables from instance', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-fileupload [pt]="pt" [name]="fileName" url="./upload" [disabled]="isDisabled"></agl-fileupload>`
            })
        ...
        describe('Case 6: Inline test', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-fileupload [pt]="{ root: 'INLINE_ROOT_CLASS', header: 'INLINE_HEADER_CLASS' }" name="test" url="./upload"></agl-fileupload>`
            })
            ...
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-fileupload [pt]="{ root: { class: 'INLINE_ROOT_OBJECT_CLASS' }, content: { class: 'INLINE_CONTENT_CLASS' } }" name="test" url="./upload"></agl-fileupload>`
            })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-fileupload name="file1" url="./upload"></agl-fileupload>
                    <agl-fileupload name="file2" url="./upload"></agl-fileupload>
                `
            })
            class TestPTCase7GlobalComponent {}

            it('should apply global PT configuration from AnguluxConfig to multiple instances', async () => {
                TestBed.resetTestingModule();
                await TestBed.configureTestingModule({
