...
@Component({
    ...
    standalone: false,
    template: `<button aglRipple class="test-button">Click me</button>`
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<div aglRipple class="test-div" [style]="style">Ripple Div</div>`
})
...
@Component({
    ...
    standalone: false,
    template: `
        <div aglRipple class="multiple-ripple-1">First</div>
        <div aglRipple class="multiple-ripple-2">Second</div>
        <span aglRipple class="multiple-ripple-3">Third</span>
    `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <div aglRipple class="nested-container">
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<div aglRipple [style]="style" [class]="styleClass">Custom Styled Ripple</div>`
})
