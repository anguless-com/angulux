...
import { CheckboxChangeEvent } from '@anguless/angulux/types/checkbox';
...
@Component({
    ...
    template: `
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
            <agl-checkbox formControlName="agreement" [binary]="true" inputId="agreement" [required]="required" (onChange)="onSelectionChange($event)"> </agl-checkbox>
            <agl-checkbox formControlName="selectedIngredients" *ngFor="let ingredient of ingredients; let i = index" [value]="ingredient.value" [inputId]="'ingredient-' + i" (onChange)="onSelectionChange($event)"> </agl-checkbox>
        </form>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-checkbox [(ngModel)]="selectedIngredients" *ngFor="let ingredient of ingredients; let i = index" [value]="ingredient.value" [inputId]="'ingredient-' + i" [name]="'pizza'" (onChange)="onSelectionChange($event)"> </agl-checkbox> `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-checkbox [(ngModel)]="value" [binary]="true" [disabled]="disabled" (onChange)="onSelectionChange($event)">
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-checkbox [(ngModel)]="value" [binary]="true" [indeterminate]="indeterminate" [trueValue]="customTrueValue" [falseValue]="customFalseValue" (onChange)="onSelectionChange($event)"> </agl-checkbox> `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-checkbox [(ngModel)]="value" [binary]="true" [variant]="variant" [size]="size" inputId="styled-checkbox" [styleClass]="styleClass" [inputStyle]="inputStyle" [inputClass]="inputClass" (onChange)="onSelectionChange($event)"> </agl-checkbox>
    `
})
...
// Checkbox aglTemplate component
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `
...
describe('Checkbox', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should create the component', async () => {
            ...
            const checkboxComponent = testFixture.debugElement.query(By.css('agl-checkbox'));
            expect(checkboxComponent).toBeTruthy();
        });

        it('should have default values', async () => {
            const checkboxInstance = testFixture.debugElement.query(By.css('agl-checkbox')).componentInstance;
    ...
    describe('Binary Checkbox Tests', () => {
        ...
        beforeEach(async () => {
            ...
            testFixture.changeDetectorRef.markForCheck();
            await testFixture.whenStable();
            checkboxInstance = testFixture.debugElement.query(By.css('agl-checkbox')).componentInstance;
        });
    ...
    describe('aglTemplate Tests', () => {
        ...
        beforeEach(async () => {
            ...
            checkboxElement = templateFixture.debugElement.query(By.css('agl-checkbox'));
            await templateFixture.whenStable();
        });

        it('should have icon aglTemplate', async () => {
        ...
        it('should process aglTemplate after content init', async () => {
            const checkboxInstance = checkboxElement.componentInstance;
        ...
        it('should handle aglTemplate changes after view init', async () => {
            const checkboxInstance = checkboxElement.componentInstance;
