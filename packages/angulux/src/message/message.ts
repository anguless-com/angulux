            ...
            <div [aglBind]="ptm('content')" [class]="cx('content')" [attr.data-p]="dataP">
                ...
                @if (containerTemplate || _containerTemplate) {
                    ...
                    <ng-template #escapeOut>
                        <span [aglBind]="ptm('text')" *ngIf="escape && text" [ngClass]="cx('text')" [attr.data-p]="dataP">{{ text }}</span>
                    </ng-template>

                    <span [aglBind]="ptm('text')" [ngClass]="cx('text')" [attr.data-p]="dataP">
                        <ng-content></ng-content>
                    </span>
                }
                @if (closable) {
                    <button [aglBind]="ptm('closeButton')" aglRipple type="button" [class]="cx('closeButton')" (click)="close($event)" [attr.aria-label]="closeAriaLabel" [attr.data-p]="dataP">
                        @if (closeIcon) {
