...
@Component({
    ...
    standalone: false,
    template: `
        <agl-message [closable]="true" [severity]="'error'">
...
describe('Message', () => {
    describe('Component Initialization', () => {
        ...
        beforeEach(async () => {
            ...
            messageEl = fixture.debugElement.query(By.css('agl-message'));
        });
    ...
    describe('Public Methods', () => {
        ...
        it('should hide message element when visible is false', async () => {
            ...
            const messageElement = fixture.debugElement.query(By.css('agl-message'));
    ...
    describe('Severity Levels', () => {
        ...
        it('should apply correct classes for different severity levels', async () => {
            ...
            for (const severity of severities) {
                ...
                const messageEl = fixture.debugElement.query(By.css('agl-message'));
                const messageInstance = messageEl.componentInstance as Message;
        ...
        it('should handle null and undefined severity', async () => {
            ...
            let messageEl = fixture.debugElement.query(By.css('agl-message'));
            expect(messageEl).toBeTruthy();
    ...
    describe('Template Content Projection - aglTemplate approach', () => {
        ...
        it('should process aglTemplate container in ngAfterContentInit', () => {
            const messageEl = fixture.debugElement.query(By.css('agl-message'));
            const messageInstance = messageEl.componentInstance as Message;
        ...
        it('should handle closeCallback in aglTemplate container', async () => {
            const messageEl = fixture.debugElement.query(By.css('agl-message'));
            const messageInstance = messageEl.componentInstance as Message;
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle multiple messages on same page', async () => {
            ...
            const message1 = fixture.debugElement.query(By.css('agl-message')).componentInstance as Message;
            const message2 = fixture2.debugElement.query(By.css('agl-message')).componentInstance as Message;
    ...
    describe('PassThrough - Case 6: Inline test', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: `<agl-message [pt]="{ root: 'INLINE_ROOT_CLASS' }" [text]="'Inline Test'"></agl-message>`
        })
        ...
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: `<agl-message [pt]="{ root: { class: 'INLINE_OBJECT_CLASS', style: { border: '2px solid blue' } } }" [text]="'Inline Test'"></agl-message>`
        })
    ...
    describe('PassThrough - Case 7: Test from AnguluxConfig', () => {
        @Component({
            ...
            standalone: false,
            template: `
                <agl-message [text]="'First Message'" [closable]="true"></agl-message>
                <agl-message [text]="'Second Message'" [closable]="true"></agl-message>
            `
        })
        ...
        it('should apply global pt configuration from AnguluxConfig', async () => {
            ...
            const messages = fixture.debugElement.queryAll(By.css('agl-message'));
        ...
        it('should apply global css from AnguluxConfig', async () => {
            await TestBed.configureTestingModule({
                imports: [Message],
                declarations: [TestGlobalPtComponent],
                providers: [
        ...
        it('should merge local pt with global pt configuration', async () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-message [pt]="{ root: 'LOCAL_ROOT_CLASS', content: 'LOCAL_CONTENT_CLASS' }" [text]="'Test'"></agl-message>`
            })
            ...
            const messageComponent = fixture.debugElement.query(By.css('agl-message'));
