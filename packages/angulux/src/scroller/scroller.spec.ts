...
@Component({
    ...
    standalone: false,
    template: `
        <agl-scroller [items]="items" [itemSize]="itemSize" [scrollHeight]="scrollHeight" [lazy]="true" [showLoader]="true">
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-scroller [items]="items" [itemSize]="itemSize" [scrollHeight]="scrollHeight" [orientation]="'both'" [columns]="columns"> </agl-scroller> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-scroller [items]="items" [itemSize]="itemSize" [scrollHeight]="scrollHeight" [lazy]="true" [step]="step" (onLazyLoad)="onLazyLoad($event)"> </agl-scroller> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-scroller [items]="dynamicItems$ | async" [itemSize]="dynamicItemSize" [scrollHeight]="dynamicScrollHeight" [orientation]="dynamicOrientation" [loading]="dynamicLoading" [disabled]="dynamicDisabled"> </agl-scroller> `
})
...
describe('Scroller', () => {
    ...
    describe('PassThrough (PT) Tests', () => {
        @Component({
            ...
            template: `
                <agl-scroller [items]="items()" [itemSize]="itemSize()" [pt]="pt()" [showLoader]="showLoader()" [loading]="loading()">
        ...
        beforeEach(async () => {
            ...
            component = fixture.componentInstance;
            scrollerElement = fixture.debugElement.query(By.css('agl-scroller'));
        ...
        describe('Case 6: Inline PT test', () => {
            @Component({
                ...
                standalone: true,
                imports: [CommonModule, Scroller],
                template: `<agl-scroller [items]="items" [itemSize]="50" [pt]="{ root: 'INLINE_TEST_CLASS' }">
            ...
            it('should apply inline PT with object', async () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [CommonModule, Scroller],
                    template: `<agl-scroller [items]="items" [itemSize]="50" [pt]="{ root: { class: 'INLINE_OBJECT_CLASS' } }">
                        <ng-template #item let-item>{{ item }}</ng-template>
                    </agl-scroller>`
                })
        ...
        describe('Case 7: Global PT from AnguluxConfig', () => {
            @Component({
                ...
                imports: [CommonModule, Scroller],
                template: `
                    <agl-scroller [items]="items1" [itemSize]="50">
                        <ng-template #item let-item>{{ item }}</ng-template>
                    </agl-scroller>
                    <agl-scroller [items]="items2" [itemSize]="50">
                        <ng-template #item let-item>{{ item }}</ng-template>
                    </agl-scroller>
                `
            })
            ...
            it('should apply global PT from AnguluxConfig', async () => {
