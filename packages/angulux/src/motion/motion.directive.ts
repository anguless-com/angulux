...
export class MotionDirective extends BaseComponent {
     ...
     * @group Props
     */
    visible = input<boolean>(false, { alias: 'aglMotion' });
    /**
     ...
     * @group Props
     */
    name = input<MotionOptions['name']>(undefined, { alias: 'aglMotionName' });
    /**
     * The type of the motion, valid values 'transition' and 'animation'.
     * @group Props
     */
    type = input<MotionOptions['type']>(undefined, { alias: 'aglMotionType' });
    /**
     * Whether the motion is safe.
     * @group Props
     */
    safe = input<MotionOptions['safe']>(undefined, { alias: 'aglMotionSafe' });
    /**
     * Whether the motion is disabled.
     * @group Props
     */
    disabled = input<MotionOptions['disabled']>(false, { alias: 'aglMotionDisabled' });
    /**
     * Whether the motion should appear.
     * @group Props
     */
    appear = input<MotionOptions['appear']>(false, { alias: 'aglMotionAppear' });
    /**
     * Whether the motion should enter.
     * @group Props
     */
    enter = input<MotionOptions['enter']>(true, { alias: 'aglMotionEnter' });
    /**
     * Whether the motion should leave.
     * @group Props
     */
    leave = input<MotionOptions['leave']>(true, { alias: 'aglMotionLeave' });
    /**
     * The duration of the motion.
     * @group Props
     */
    duration = input<MotionOptions['duration']>(undefined, { alias: 'aglMotionDuration' });
    /**
     * The hide strategy of the motion, valid values 'display' and 'visibility'.
     * @group Props
     */
    hideStrategy = input<'display' | 'visibility'>('display', { alias: 'aglMotionHideStrategy' });
    /**
     * The enter from class of the motion.
     * @group Props
     */
    enterFromClass = input<ClassNameOptions['from']>(undefined, { alias: 'aglMotionEnterFromClass' });
    /**
     * The enter to class of the motion.
     * @group Props
     */
    enterToClass = input<ClassNameOptions['to']>(undefined, { alias: 'aglMotionEnterToClass' });
    /**
     * The enter active class of the motion.
     * @group Props
     */
    enterActiveClass = input<ClassNameOptions['active']>(undefined, { alias: 'aglMotionEnterActiveClass' });
    /**
     * The leave from class of the motion.
     * @group Props
     */
    leaveFromClass = input<ClassNameOptions['from']>(undefined, { alias: 'aglMotionLeaveFromClass' });
    /**
     * The leave to class of the motion.
     * @group Props
     */
    leaveToClass = input<ClassNameOptions['to']>(undefined, { alias: 'aglMotionLeaveToClass' });
    /**
     * The leave active class of the motion.
     * @group Props
     */
    leaveActiveClass = input<ClassNameOptions['active']>(undefined, { alias: 'aglMotionLeaveActiveClass' });
     ...
     * @group Props
     */
    options = input<MotionOptions>({}, { alias: 'aglMotionOptions' });
     ...
     * @group Emits
     */
    onBeforeEnter = output<MotionEvent | undefined>({ alias: 'aglMotionOnBeforeEnter' });
    /**
     ...
     * @group Emits
     */
    onEnter = output<MotionEvent | undefined>({ alias: 'aglMotionOnEnter' });
    /**
     ...
     * @group Emits
     */
    onAfterEnter = output<MotionEvent | undefined>({ alias: 'aglMotionOnAfterEnter' });
    /**
     ...
     * @group Emits
     */
    onEnterCancelled = output<MotionEvent | undefined>({ alias: 'aglMotionOnEnterCancelled' });
    /**
     ...
     * @group Emits
     */
    onBeforeLeave = output<MotionEvent | undefined>({ alias: 'aglMotionOnBeforeLeave' });
    /**
     ...
     * @group Emits
     */
    onLeave = output<MotionEvent | undefined>({ alias: 'aglMotionOnLeave' });
    /**
     ...
     * @group Emits
     */
    onAfterLeave = output<MotionEvent | undefined>({ alias: 'aglMotionOnAfterLeave' });
    /**
     ...
     * @group Emits
     */
    onLeaveCancelled = output<MotionEvent | undefined>({ alias: 'aglMotionOnLeaveCancelled' });
