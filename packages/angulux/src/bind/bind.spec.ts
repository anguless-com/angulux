...
@Component({
    ...
    template: `<div [aglBind]="attrs"></div>`
})
...
@Component({
    ...
    template: `<div [aglBind]="attrs" class="existing-class" style="margin: 10px;"></div>`
})
...
@Component({
    ...
    template: `<div [aglBind]="undefined"></div>`
})
...
describe('Bind', () => {
    ...
    describe('setAttrs Method', () => {
        ...
        it('should prioritize setAttrs over aglBind input', async () => {
            const fixture = TestBed.createComponent(TestBasicBindComponent);
            const component = fixture.componentInstance;
