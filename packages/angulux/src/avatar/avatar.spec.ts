...
@Component({
    ...
    template: `<agl-avatar></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [label]="label"></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [icon]="icon"></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [image]="image" [ariaLabel]="ariaLabel" (onImageError)="onImageError($event)"></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [label]="label" [size]="size"></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [label]="label" [shape]="shape"></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [label]="label" [styleClass]="styleClass"></agl-avatar>`
})
...
@Component({
    ...
    template: `<agl-avatar [label]="label" [ariaLabel]="ariaLabel" [ariaLabelledBy]="ariaLabelledBy"></agl-avatar>`
})
...
@Component({
    ...
    template: ` <agl-avatar [label]="label" [icon]="icon" [image]="image" [size]="size" [shape]="shape" [styleClass]="styleClass" [ariaLabel]="ariaLabel" [ariaLabelledBy]="ariaLabelledBy" (onImageError)="onImageError($event)"> </agl-avatar> `
})
...
@Component({
    ...
    standalone: true,
    imports: [Avatar],
    template: `<agl-avatar [label]="label()" [icon]="icon()" [image]="image()" [size]="size()" [shape]="shape()" [ariaLabel]="ariaLabel()" [pt]="pt()"></agl-avatar>`
})
