...
@Component({
    ...
    standalone: false,
    template: `
        <agl-card [header]="header" [subheader]="subheader" [styleClass]="styleClass" [style]="style">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-card header="Simple Header" subheader="Simple Subheader">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-card [header]="header" [subheader]="subheader">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-card subheader="Subheader Only">
...
describe('Card', () => {
    ...
    describe('CSS Classes and Styling', () => {
        it('should apply base component classes correctly', () => {
            const cardElement = fixture.debugElement.query(By.css('agl-card'));
        ...
        describe('Case 7: Global PT from AnguluxConfig', () => {
            it('should apply global PT configuration from AnguluxConfig', async () => {
                @Component({
                    ...
                    standalone: false,
                    template: `
                        <agl-card header="Card 1"></agl-card>
                        <agl-card header="Card 2"></agl-card>
                    `
                })
            ...
            it('should merge local PT with global PT', async () => {
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-card [pt]="localPt" header="Test"></agl-card>`
                })
                ...
                const cardEl = fixture.debugElement.query(By.css('agl-card'));
        ...
        xdescribe('Case 8: PT Hooks', () => {
            ...
            xit('should execute onAfterViewInit hook from PT', async () => {
                ...
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-card [pt]="pt"></agl-card>`
                })
        ...
        describe('Advanced PT Scenarios', () => {
            ...
            it('should handle PT with function returning classes based on instance', async () => {
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-card [pt]="pt" [header]="header"></agl-card>`
                })
            ...
            it('should handle dynamic PT updates', async () => {
                ...
                let cardEl = fixture.debugElement.query(By.css('agl-card'));
            ...
            it('should handle PT function with instance-based styles', async () => {
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-card [pt]="pt" [header]="header" [subheader]="subheader"></agl-card>`
                })
