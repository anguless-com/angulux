...
// ConfirmDialog with aglTemplate Templates
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-confirmdialog [position]="position" [visible]="visible"> </agl-confirmdialog> `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-confirmdialog></agl-confirmdialog>
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-confirmdialog [visible]="true" [acceptAriaLabel]="acceptAriaLabel" [rejectAriaLabel]="rejectAriaLabel" [closeAriaLabel]="closeAriaLabel" header="Accessibility Test" message="Test message"> </agl-confirmdialog> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-confirmdialog [visible]="visible" (onHide)="onHide($event)"> </agl-confirmdialog> `
})
...
describe('ConfirmDialog', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should have proper data attributes', () => {
            const dialogElement = fixture.debugElement.query(By.css('agl-dialog'));
    ...
    describe('Button Functionality', () => {
        it('should display accept button when acceptVisible is true', async () => {
            ...
            const acceptButton = fixture.debugElement.queryAll(By.css('agl-button')).find((btn) => btn.nativeElement.textContent?.includes('Yes') || btn.componentInstance.ariaLabel?.includes('accept'));
        ...
        it('should hide accept button when acceptVisible is false', async () => {
            ...
            const buttons = fixture.debugElement.queryAll(By.css('agl-button'));
        ...
        it('should display reject button when rejectVisible is true', async () => {
            ...
            const rejectButton = fixture.debugElement.queryAll(By.css('agl-button')).find((btn) => btn.nativeElement.textContent?.includes('No') || btn.componentInstance.ariaLabel?.includes('reject'));
    ...
    describe('Accessibility Tests', () => {
        it('should have proper ARIA attributes on dialog', async () => {
            ...
            const dialog = accessibilityFixture.debugElement.query(By.css('agl-dialog'));
        ...
        it('should have proper focus trap behavior', async () => {
            ...
            const dialog = fixture.debugElement.query(By.css('agl-dialog'));
    ...
    describe('PT (PassThrough) Tests', () => {
        describe('Case 1: Simple string classes', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-confirmdialog [pt]="pt" key="test"></agl-confirmdialog>
        ...
        describe('Case 4: Use variables from instance', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-confirmdialog [pt]="pt" key="test" [visible]="isVisible"></agl-confirmdialog>
                    <button (click)="confirm()">Confirm</button>
                `
            })
        ...
        describe('Case 6: Inline test', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-confirmdialog [pt]="{ pcDialog: 'INLINE_DIALOG_CLASS', message: 'INLINE_MESSAGE_CLASS' }" key="test"></agl-confirmdialog>
                    <button (click)="confirm()">Confirm</button>
                `
            })
            ...
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-confirmdialog [pt]="{ pcDialog: { class: 'INLINE_DIALOG_OBJECT_CLASS' }, icon: { class: 'INLINE_ICON_CLASS' } }" key="test"></agl-confirmdialog>
                    <button (click)="confirm()">Confirm</button>
                `
            })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-confirmdialog key="test1"></agl-confirmdialog>
                    <button (click)="confirm('test1')">Confirm 1</button>
                    <agl-confirmdialog key="test2"></agl-confirmdialog>
