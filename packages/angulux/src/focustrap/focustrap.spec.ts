...
@Component({
    ...
    template: `
        <div aglFocusTrap [aglFocusTrapDisabled]="disabled">
...
@Component({
    ...
    template: `
        <div aglFocusTrap [aglFocusTrapDisabled]="trapDisabled">
...
@Component({
    ...
    template: `
        <div aglFocusTrap class="outer-trap">
            <input type="text" class="outer-input" />
            <div class="nested-container">
                <div aglFocusTrap class="inner-trap">
...
@Component({
    ...
    template: `
        <div aglFocusTrap [aglFocusTrapDisabled]="trapDisabled" class="complex-trap">
...
@Component({
    ...
    template: `
        <div aglFocusTrap class="empty-trap">
...
describe('FocusTrap', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should have default values', () => {
            expect(directive.aglFocusTrapDisabled).toBe(false);
        });
    ...
    describe('Lifecycle Hooks', () => {
        ...
        it('should handle ngOnChanges for aglFocusTrapDisabled', () => {
            const changes = {
                aglFocusTrapDisabled: {
                    currentValue: true,
                    previousValue: false,
                    firstChange: false,
                    isFirstChange: () => false
