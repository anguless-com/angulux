...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-datepicker formControlName="date" [dateFormat]="'dd/mm/yy'" [placeholder]="'Select date'"></agl-datepicker>
        </form>
    `
})
...
describe('DatePicker', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should accept custom values', async () => {
            ...
            const datePickerComponent = testFixture.debugElement.query(By.css('agl-datepicker')).componentInstance;
    ...
    describe('Locale and Internationalization', () => {
        it('should handle locale via configuration service', () => {
            // Locale is handled via AnguluxConfig config service, not direct input
    ...
    describe('aglTemplate Content Projection', () => {
        ...
        beforeEach(async () => {
            ...
            pTemplatesDatePickerElement = pTemplatesFixture.debugElement.query(By.css('agl-datepicker'));
    ...
    describe('#template Reference Content Projection', () => {
        ...
        beforeEach(async () => {
            ...
            refTemplatesDatePickerElement = refTemplatesFixture.debugElement.query(By.css('agl-datepicker'));
    ...
    describe('Templates and Content Projection (Legacy)', () => {
        ...
        beforeEach(async () => {
            ...
            templatesDatePickerElement = templatesFixture.debugElement.query(By.css('agl-datepicker'));
