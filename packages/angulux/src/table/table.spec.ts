...
describe('Table', () => {
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products" [dataKey]="'id'">
                <ng-template #header>
                    <tr>
                        <th>ID</th>
                        <th>Code</th>
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products" [selection]="selectedProducts" [selectionMode]="'multiple'" [dataKey]="'id'">
                <ng-template #header>
                    <tr>
                        <th><agl-tableHeaderCheckbox></agl-tableHeaderCheckbox></th>
                        <th>Name</th>
                        <th>Price</th>
                        <th>Status</th>
                    </tr>
                ...
                <ng-template #body let-product>
                    <tr>
                        <td><agl-tableCheckbox [value]="product"></agl-tableCheckbox></td>
                        <td>{{ product.name }}</td>
                        <td>{{ product.price | currency }}</td>
                        <td>{{ product.inventoryStatus }}</td>
                    </tr>
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products" [sortMode]="'multiple'">
                <ng-template #header>
                    <tr>
                        <th aglSortableColumn="name">Name <agl-sortIcon field="name"></agl-sortIcon></th>
                        <th aglSortableColumn="price">Price <agl-sortIcon field="price"></agl-sortIcon></th>
                        <th aglSortableColumn="category">Category <agl-sortIcon field="category"></agl-sortIcon></th>
                    </tr>
                </ng-template>
                <ng-template #body let-product>
                    <tr>
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products" [globalFilterFields]="['name', 'category']">
                <ng-template #header>
                    <tr>
                        <th>
                            Name
                            <agl-columnFilter field="name" matchMode="contains" display="menu">
                        ...
                        <th>
                            Category
                            <agl-columnFilter field="category" matchMode="equals" display="menu">
                                <ng-template #filter let-value let-filter="filterCallback">
                                    <agl-select [(ngModel)]="value" [options]="categories" (ngModelChange)="filter($event)" placeholder="Select Category"> </agl-select>
                                </ng-template>
                            </agl-columnFilter>
                        </th>
                    </tr>
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products" [virtualScroll]="true" [virtualScrollItemSize]="46" [scrollHeight]="'400px'">
                <ng-template #header>
                    <tr>
                        <th>ID</th>
                        <th>Name</th>
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products" [lazy]="true" [totalRecords]="totalRecords" [paginator]="true" [rows]="10" (onLazyLoad)="loadProducts($event)">
                <ng-template #header>
                    <tr>
                        <th>Name</th>
                        <th>Price</th>
    ...
    @Component({
        ...
        standalone: false,
        template: `
            <agl-table [value]="products">
                <ng-template #caption>
                    <div class="p-d-flex p-ai-center p-jc-between">
                        <h5>Product Catalog</h5>
                        <span class="p-input-icon-left">
                            <i class="pi pi-search"></i>
                            <input type="text" aglInputText placeholder="Global Search" />
                        </span>
                    </div>
                </ng-template>
                <ng-template #header>
    ...
    describe('Basic Table Functionality', () => {
        ...
        it('should render table with product data', () => {
            const tableElement = testFixture.debugElement.query(By.css('agl-table'));
        ...
        it('should have correct dataKey', () => {
            const tableInstance = testFixture.debugElement.query(By.css('agl-table')).componentInstance;
    ...
    describe('Selection Functionality', () => {
        ...
        it('should render checkboxes for selection', () => {
            const checkboxes = testFixture.debugElement.queryAll(By.css('agl-tableCheckbox'));
            expect(checkboxes.length).toBe(testComponent.products.length);
        });

        it('should render header checkbox for select all', () => {
            const headerCheckbox = testFixture.debugElement.query(By.css('agl-tableHeaderCheckbox'));
    ...
    describe('Sorting Functionality', () => {
        ...
        it('should render sort icons', () => {
            const sortIcons = testFixture.debugElement.queryAll(By.css('agl-sortIcon'));
            expect(sortIcons.length).toBe(3);
        });

        it('should have sortable columns', () => {
            const sortableColumns = testFixture.debugElement.queryAll(By.css('[aglSortableColumn]'));
    ...
    describe('Filtering Functionality', () => {
        ...
        it('should render column filters', () => {
            const columnFilters = testFixture.debugElement.queryAll(By.css('agl-columnFilter'));
    ...
    describe('Real-Life Scenarios - E-commerce Product Management', () => {
        ...
        it('should handle inventory status filtering for stock management', async () => {
            const tableInstance = ecommerceFixture.debugElement.query(By.css('agl-table')).componentInstance;
    ...
    describe('PassThrough', () => {
            ...
            template: `
                ...
                >
                    ...
                    <ng-template #header>
                        <tr>
                            <th><agl-tableHeaderCheckbox></agl-tableHeaderCheckbox></th>
                            <th aglReorderableColumn aglResizableColumn>
                                Name
                                <agl-columnFilter field="name" matchMode="contains" display="menu">
                                    <ng-template #filter let-value let-filter="filterCallback">
                            ...
                            <th aglReorderableColumn aglResizableColumn>Price</th>
                            <th aglReorderableColumn aglResizableColumn>Category</th>
                        </tr>
                    </ng-template>
                    <ng-template #body let-product let-rowIndex="rowIndex">
                        <tr [aglReorderableRow]="rowIndex">
                            <td><agl-tableCheckbox [value]="product"></agl-tableCheckbox></td>
                            <td>
                                <span aglReorderableRowHandle class="pi pi-bars"></span>
                                {{ product.name }}
                            </td>
                            <td>{{ product.price | currency }}</td>
                            <td>{{ product.category }}</td>
        ...
        it('PT Section 1: host - should apply PT to host DOM element', async () => {
            ...
            const tableElement = fixture.nativeElement.querySelector('agl-table');
            expect(tableElement).toBeTruthy();
        });
        ...
        it('PT Section 19: reorderableRowHandle - should apply PT to reorderable row handle element', async () => {
            ...
            const handles = fixture.nativeElement.querySelectorAll('[aglreorderablerowhandle]');
        ...
        it('PT Section 20: headerCheckbox - should apply PT to header checkbox component', async () => {
            ...
            const headerCheckbox = fixture.nativeElement.querySelector('agl-tableheadercheckbox');
            expect(headerCheckbox).toBeTruthy();
        });
        ...
        it('PT Section 21: pcCheckbox - should apply PT to checkbox component', async () => {
            ...
            const checkboxes = fixture.nativeElement.querySelectorAll('agl-tablecheckbox');
        ...
        it('PT Section 22: columnFilter.filter - should apply PT to filter container element', async () => {
            ...
            const filterEl = fixture.nativeElement.querySelector('agl-columnfilter');
    ...
    describe('Cell Navigation', () => {
        ...
        @Component({
            ...
            standalone: false,
            template: `
                <agl-table [value]="products" [dataKey]="'id'" editMode="cell">
                    <ng-template #header>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
                    ...
                    <ng-template #body let-product let-rowIndex="rowIndex">
                        <tr>
                            ...
                            <td [aglEditableColumn]="product" [aglEditableColumnField]="'name'" [aglEditableColumnRowIndex]="rowIndex">
                                <agl-cellEditor>
                                    <ng-template #input>
                                        <input aglInputText type="text" [(ngModel)]="product.name" class="name-input" />
                                    </ng-template>
                                    <ng-template #output>
                                        {{ product.name }}
                                    </ng-template>
                            ...
                            <td [aglEditableColumn]="product" [aglEditableColumnField]="'price'" [aglEditableColumnRowIndex]="rowIndex">
                                <agl-cellEditor>
                                    <ng-template #input>
                                        <input aglInputText type="text" [(ngModel)]="product.price" class="price-input" />
                                    </ng-template>
                                    <ng-template #output>
            ...
            @Component({
                ...
                template: `
                    <agl-table [value]="products" [dataKey]="'id'" editMode="cell">
                        ...
                        <ng-template #body let-product let-rowIndex="rowIndex">
                            <tr>
                                <td [aglEditableColumn]="product" [aglEditableColumnField]="'name'" [aglEditableColumnRowIndex]="rowIndex" [aglEditableColumnDisabled]="true">
                                    <agl-cellEditor>
                                        <ng-template #input>
                                            <input aglInputText type="text" [(ngModel)]="product.name" class="name-input" />
                                        </ng-template>
