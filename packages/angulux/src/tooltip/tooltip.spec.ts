...
@Component({
    ...
    template: `
        <input
            #inputElement
            aglTooltip="Default tooltip text"
...
@Component({
    ...
    standalone: false,
    template: `
        <input #templateElement [aglTooltip]="tooltipTemplate" type="text" placeholder="Template tooltip" />
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <button #buttonElement aglTooltip="Button tooltip" [tooltipOptions]="options" type="button">Click me</button> `
})
...
describe('Tooltip', () => {
    ...
    describe('PassThrough', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <input #inputElement aglTooltip="PT Test Tooltip" [pt]="pt" type="text" /> `
        })
