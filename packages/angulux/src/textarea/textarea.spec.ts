...
@Component({
    ...
    template: ` <textarea aglTextarea [(ngModel)]="value" placeholder="Enter text"></textarea> `
})
...
@Component({
    ...
    standalone: true,
    imports: [Textarea, FormsModule],
    template: ` <textarea aglTextarea [(ngModel)]="content" [autoResize]="enableAutoResize" [aglSize]="size" [variant]="variant" [fluid]="fluid" [invalid]="invalid" (onResize)="onResizeHandler($event)" rows="3" cols="30"> </textarea> `
})
...
@Component({
    ...
    template: ` <textarea aglTextarea [formControl]="textControl"></textarea> `
})
...
@Component({
    ...
    standalone: true,
    imports: [Textarea, FormsModule],
    template: ` <textarea aglTextarea [(ngModel)]="value" [pt]="pt" [autoResize]="autoResize" [invalid]="invalid"></textarea> `
})
...
describe('Textarea', () => {
    describe('Basic Functionality', () => {
        ...
        it('should apply aglTextarea directive', () => {
        ...
        it('should have textarea element with directive applied', () => {
            expect(textareaEl.nativeElement.hasAttribute('aglTextarea')).toBe(true);
        });
    ...
    describe('Advanced Features', () => {
        ...
        it('should apply size variants', async () => {
            ...
            expect(textareaDirective.aglSize).toBe('large');
            ...
            expect(textareaDirective.aglSize).toBe('small');
        });
