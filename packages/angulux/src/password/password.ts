...
export class PasswordDirective extends BaseEditableHolder {
     ...
     * @group Props
     */
    size = input<'large' | 'small' | undefined>(undefined, { alias: 'aglSize' });
                ...
                <div [class]="cx('overlay')" [style]="sx('overlay')" (click)="onOverlayClick($event)" [aglBind]="ptm('overlay')" [attr.data-p]="overlayDataP">
                    ...
                    <ng-template #defaultContent>
                        <div [class]="cx('content')" [aglBind]="ptm('content')">
                            <div [class]="cx('meter')" [aglBind]="ptm('meter')">
                                <div [class]="cx('meterLabel')" [ngStyle]="{ width: meter ? meter.width : '' }" [aglBind]="ptm('meterLabel')" [attr.data-p]="meterDataP"></div>
                            </div>
