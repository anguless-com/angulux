...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-password formControlName="password" [feedback]="feedback" [toggleMask]="toggleMask"> </agl-password>
        </form>
    `
})
...
// Password aglTemplate component
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <input type="password" aglPassword [(ngModel)]="value" [feedback]="feedback" [promptLabel]="promptLabel" [weakLabel]="weakLabel" [mediumLabel]="mediumLabel" [strongLabel]="strongLabel" /> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <input type="password" aglPassword [(ngModel)]="value" [pt]="pt" [feedback]="feedback" /> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-password [(ngModel)]="value" [pt]="pt" [feedback]="feedback" [toggleMask]="toggleMask" [showClear]="showClear"> </agl-password> `
})
...
describe('Password', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should handle keyup events for strength feedback', async () => {
            ...
            const inputEl = testFixture.debugElement.query(By.css('input'));
            const passwordComponent = testFixture.debugElement.query(By.css('agl-password')).componentInstance;
    ...
    describe('Form Integration', () => {
        ...
        it('should handle rapid value changes', async () => {
            const passwordComponent = formTestFixture.debugElement.query(By.css('agl-password')).componentInstance;
            let changeCount = 0;
    ...
    describe('Password aglTemplate Tests', () => {
        ...
        beforeEach(async () => {
            ...
            templatesPasswordElement = templatesFixture.debugElement.query(By.css('agl-password'));
        ...
        it('should support dual template approach (aglTemplate + #template)', () => {
            ...
            templateElements.forEach((template) => {
                const pTemplateValue = template.nativeElement.getAttribute('aglTemplate');
                if (pTemplateValue) {
                    // Should have both aglTemplate attribute and local reference
                    expect(template.nativeElement.hasAttribute('aglTemplate')).toBe(true);
...
describe('PasswordDirective', () => {
    ...
    describe('PasswordDirective PassThrough Tests', () => {
        ...
        describe('Case 7: Global PT from AnguluxConfig', () => {
            it('should have global pt configuration available', async () => {
                ...
                expect(globalInputEl.hasAttribute('aglpassword')).toBe(true);
            });
            ...
            it('should instantiate multiple directive instances with global config', async () => {
                ...
                expect(el1.hasAttribute('aglpassword')).toBe(true);
                expect(el2.hasAttribute('aglpassword')).toBe(true);
            });
        });
...
describe('Password PassThrough Tests', () => {
    ...
    beforeEach(async () => {
        ...
        component = fixture.componentInstance;
        fixture.detectChanges();
        passwordEl = fixture.debugElement.query(By.css('agl-password')).nativeElement;
    });
    ...
    describe('Case 7: Global PT from AnguluxConfig', () => {
        it('should apply global pt configuration', async () => {
            ...
            const globalPasswordEl = globalFixture.debugElement.query(By.css('agl-password')).nativeElement;
        ...
        it('should apply global pt to multiple instances', async () => {
            ...
            const el1 = fixture1.debugElement.query(By.css('agl-password')).nativeElement;
            const el2 = fixture2.debugElement.query(By.css('agl-password')).nativeElement;
