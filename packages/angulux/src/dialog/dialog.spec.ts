...
// Dialog with aglTemplate Templates
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-dialog [(visible)]="visible" [modal]="true" [maximizable]="true">
            <ng-template #header>
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-dialog [(visible)]="visible" [position]="position" header="Position Test">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-dialog [(visible)]="visible" [maximizable]="maximizable" header="Maximizable Test" (onMaximize)="onMaximize($event)">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-dialog [(visible)]="visible" [modal]="true" header="Accessibility Test" [closeAriaLabel]="closeAriaLabel" [role]="role" [focusTrap]="focusTrap">
...
describe('Dialog', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should close dialog when close button is clicked', async () => {
            ...
            const closeButton = fixture.debugElement.query(By.css('agl-button[aria-label="Close Dialog"], .p-dialog-close-button, [class*="pcCloseButton"]'));
    ...
    describe('Keyboard Navigation', () => {
        ...
        it('should handle Enter key on close button', async () => {
            ...
            const closeButton = fixture.debugElement.query(By.css('agl-button[class*="pcCloseButton"]'));
            if (closeButton) {
        ...
        it('should handle Enter key on maximize button', async () => {
            ...
            const maximizeButton = fixture.debugElement.query(By.css('agl-button[class*="pcMaximizeButton"]'));
            if (maximizeButton) {
                const enterEvent = new KeyboardEvent('keydown', { key: 'Enter' });
    ...
    describe('Templates', () => {
        describe('aglTemplate Approach Tests', () => {
            ...
            it('should render custom header with aglTemplate', async () => {
                ...
                expect(customHeader.nativeElement.textContent.trim()).toBe('Custom Header with aglTemplate');
            });

            it('should render custom content with aglTemplate', async () => {
                pTemplateComponent.visible = true;
                pTemplateFixture.changeDetectorRef.markForCheck();
                await pTemplateFixture.whenStable();
                await new Promise((resolve) => setTimeout(resolve, 0));
                ...
                expect(customContent.nativeElement.textContent.trim()).toBe('Custom content with aglTemplate');
            });

            it('should render custom footer with aglTemplate', async () => {
                pTemplateComponent.visible = true;
                pTemplateFixture.changeDetectorRef.markForCheck();
                await pTemplateFixture.whenStable();
                await new Promise((resolve) => setTimeout(resolve, 0));
                ...
                expect(customFooter.nativeElement.textContent.trim()).toBe('Custom footer with aglTemplate');
            });

            it('should render custom close icon with aglTemplate', async () => {
                pTemplateComponent.visible = true;
                pTemplateFixture.changeDetectorRef.markForCheck();
                await pTemplateFixture.whenStable();
                await new Promise((resolve) => setTimeout(resolve, 0));
    ...
    describe('Maximizable Functionality', () => {
        ...
        it('should show maximize button when maximizable is true', async () => {
            ...
            let maximizeButton = maximizableFixture.debugElement.query(By.css('agl-button[class*="pcMaximizeButton"]'));
            if (!maximizeButton) {
                maximizeButton = maximizableFixture.debugElement.query(By.css('.p-dialog-maximize-button'));
            }
            if (!maximizeButton) {
                maximizeButton = maximizableFixture.debugElement.query(By.css('agl-button[aria-label*="maximize"], agl-button[aria-label*="Maximize"]'));
            }
            if (!maximizeButton) {
                ...
                if (headerActions) {
                    maximizeButton = headerActions.query(By.css('agl-button'));
                }
            }
    ...
    describe('PT (PassThrough) Tests', () => {
        describe('Case 1: Simple string classes', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-dialog [pt]="pt" [visible]="visible" header="Test Dialog">Content</agl-dialog>`
            })
        ...
        describe('Case 4: Use variables from instance', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-dialog [pt]="pt" [visible]="visible" [maximizable]="isMaximizable" header="Test Dialog">Content</agl-dialog>`
            })
        ...
        describe('Case 6: Inline test', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-dialog [pt]="{ mask: 'INLINE_MASK_CLASS', header: 'INLINE_HEADER_CLASS' }" [visible]="visible" header="Test Dialog">Content</agl-dialog>`
            })
            ...
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-dialog [pt]="{ mask: { class: 'INLINE_MASK_OBJECT_CLASS' }, content: { class: 'INLINE_CONTENT_CLASS' } }" [visible]="visible" header="Test Dialog">Content</agl-dialog>`
            })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `
                    <agl-dialog [visible]="visible1" header="Dialog 1">Content 1</agl-dialog>
                    <agl-dialog [visible]="visible2" header="Dialog 2">Content 2</agl-dialog>
                `
            })
            ...
            it('should apply global PT configuration from AnguluxConfig', async () => {
                TestBed.resetTestingModule();
                await TestBed.configureTestingModule({
