...
@Component({
    ...
    template: `
        <form [formGroup]="form" (ngSubmit)="onSubmit()">
            <agl-colorpicker formControlName="selectedColor" [format]="format" [defaultColor]="defaultColor" (onChange)="onColorChange($event)"> </agl-colorpicker>
        </form>
    `
})
...
@Component({
    ...
    template: `
        <div>
            <agl-colorpicker [(ngModel)]="hexColor" format="hex" inputId="hex-picker"> </agl-colorpicker>
        </div>
        <div>
            <agl-colorpicker [(ngModel)]="rgbColor" format="rgb" inputId="rgb-picker"> </agl-colorpicker>
        </div>
        <div>
            <agl-colorpicker [(ngModel)]="hsbColor" format="hsb" inputId="hsb-picker"> </agl-colorpicker>
        </div>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-colorpicker [(ngModel)]="color" [inline]="true" [disabled]="disabled" (onChange)="onColorChange($event)"> </agl-colorpicker> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-colorpicker [(ngModel)]="color" [disabled]="disabled" [autofocus]="autofocus" [inputId]="inputId" [tabindex]="tabindex" [defaultColor]="defaultColor" (onChange)="onColorChange($event)"> </agl-colorpicker> `
})
...
describe('ColorPicker', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should create the component', () => {
            ...
            const colorPickerComponent = testFixture.debugElement.query(By.css('agl-colorpicker'));
            expect(colorPickerComponent).toBeTruthy();
        });

        it('should have default values', () => {
            const colorPickerInstance = testFixture.debugElement.query(By.css('agl-colorpicker')).componentInstance;
    ...
    describe('Basic Functionality Tests', () => {
        ...
        beforeEach(async () => {
            ...
            testComponent = testFixture.componentInstance;
            await testFixture.whenStable();
            colorPickerInstance = testFixture.debugElement.query(By.css('agl-colorpicker')).componentInstance;
        });
    ...
    describe('Performance Tests', () => {
        it('should handle multiple color pickers efficiently', async () => {
            ...
            const colorPickers = multipleTestComponent.debugElement.queryAll(By.css('agl-colorpicker'));
    ...
    describe('PassThrough (PT) Tests', () => {
        ...
        it('PT Case 7: should work with inline PT binding - string values', async () => {
            ...
            const rootEl = fixture.nativeElement.querySelector('agl-colorpicker');
        ...
        // Case 8: Test from AnguluxConfig (global PT)
        it('PT Case 8a: should apply global PT configuration from AnguluxConfig', async () => {
            TestBed.configureTestingModule({
                imports: [ColorPicker, FormsModule],
                providers: [
                    provideZonelessChangeDetection(),
        ...
        it('PT Case 8d: should apply to multiple instances from global config', async () => {
            @Component({
                ...
                imports: [ColorPicker, FormsModule],
                template: `
                    <agl-colorpicker [inline]="true" id="picker1"></agl-colorpicker>
                    <agl-colorpicker [inline]="true" id="picker2"></agl-colorpicker>
                    <agl-colorpicker [inline]="true" id="picker3"></agl-colorpicker>
                `
            })
            ...
            const pickers = fixture.nativeElement.querySelectorAll('agl-colorpicker');
