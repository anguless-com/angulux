...
// Button with aglButtonIcon and aglButtonLabel directives
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `
        <button aglButton>
            <span aglButtonIcon class="pi pi-check"></span>
            <span aglButtonLabel>Icon & Label</span>
        </button>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-button [label]="label" [loading]="loading" [loadingIcon]="loadingIcon" (onClick)="toggleLoading()"> </agl-button> `
})
...
@Component({
    ...
    template: `
        <div class="button-group">
            <agl-button label="Primary" severity="primary"></agl-button>
            <agl-button label="Secondary" severity="secondary"></agl-button>
            <agl-button label="Success" severity="success"></agl-button>
            <agl-button label="Info" severity="info"></agl-button>
            <agl-button label="Warn" severity="warn"></agl-button>
            <agl-button label="Danger" severity="danger"></agl-button>
            <agl-button label="Help" severity="help"></agl-button>
            <agl-button label="Contrast" severity="contrast"></agl-button>
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div class="variant-buttons">
            <agl-button label="Raised" [raised]="true"></agl-button>
            <agl-button label="Rounded" [rounded]="true"></agl-button>
            <agl-button label="Text" [text]="true"></agl-button>
            <agl-button label="Outlined" [outlined]="true"></agl-button>
            <agl-button label="Plain" [plain]="true"></agl-button>
            <agl-button label="Small" size="small"></agl-button>
            <agl-button label="Large" size="large"></agl-button>
            <agl-button label="Fluid" [fluid]="true"></agl-button>
        </div>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-button label="Messages" icon="pi pi-envelope" [badge]="badge" [badgeSeverity]="badgeSeverity"> </agl-button> `
})
...
@Component({
    ...
    template: `
        <div class="icon-buttons">
            <agl-button icon="pi pi-search" [iconPos]="iconPos"></agl-button>
            <agl-button label="Search" icon="pi pi-search" iconPos="left"></agl-button>
            <agl-button label="Search" icon="pi pi-search" iconPos="right"></agl-button>
            <agl-button label="Search" icon="pi pi-search" iconPos="top"></agl-button>
            <agl-button label="Search" icon="pi pi-search" iconPos="bottom"></agl-button>
        </div>
    `
})
...
describe('Button', () => {
    ...
    describe('Badge Functionality', () => {
        it('should display badge', async () => {
            ...
            const badgeElement = badgeFixture.debugElement.query(By.css('agl-badge'));
