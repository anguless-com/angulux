...
@Component({
    ...
    standalone: false,
    template: `<agl-progressspinner [strokeWidth]="strokeWidth" [fill]="fill" [animationDuration]="animationDuration" [ariaLabel]="ariaLabel" [styleClass]="styleClass"> </agl-progressspinner>`
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<agl-progressspinner [style]="style" [styleClass]="styleClass"></agl-progressspinner>`
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<agl-progressspinner strokeWidth="4" fill="red" animationDuration="3s" ariaLabel="Loading content"> </agl-progressspinner>`
})
...
describe('ProgressSpinner', () => {
    ...
    describe('PassThrough API', () => {
        @Component({
            ...
            standalone: true,
            imports: [ProgressSpinner],
            template: `<agl-progressspinner [strokeWidth]="strokeWidth()" [fill]="fill()" [animationDuration]="animationDuration()" [ariaLabel]="ariaLabel()" [pt]="pt()"></agl-progressspinner>`
        })
