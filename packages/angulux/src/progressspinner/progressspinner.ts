...
import { ProgressSpinnerPassThrough } from '@anguless/angulux/types/progressspinner';
 ...
 */
@Component({
    selector: 'agl-progressSpinner, agl-progress-spinner, agl-progressspinner',
    standalone: true,
    imports: [CommonModule, SharedModule, Bind],
    template: `
        <svg [class]="cx('spin')" [aglBind]="ptm('spin')" viewBox="25 25 50 50" [style.animation-duration]="animationDuration">
            <circle [class]="cx('circle')" [aglBind]="ptm('circle')" cx="50" cy="50" r="20" [attr.fill]="fill" [attr.stroke-width]="strokeWidth" stroke-miterlimit="10" />
        </svg>
    `,
