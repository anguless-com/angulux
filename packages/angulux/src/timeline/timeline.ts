...
import { BlockableUI, AglTemplate, SharedModule } from 'angulux/api';
...
import { TimelineItemTemplateContext, TimelinePassThrough } from 'angulux/types/timeline';
...
export class Timeline extends BaseComponent<TimelinePassThrough> implements BlockableUI {
    ...
    @ContentChildren(AglTemplate) templates: Nullable<QueryList<any>>;
