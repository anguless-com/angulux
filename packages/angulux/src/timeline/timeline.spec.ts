...
@Component({
    ...
    standalone: false,
    template: ` <agl-timeline [value]="events" [align]="align" [layout]="layout" [styleClass]="styleClass"> </agl-timeline> `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-timeline [value]="events" [align]="align">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-timeline [value]="events" [layout]="layout" [align]="align">
            <ng-template #content let-event>
