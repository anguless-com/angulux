...
export class BaseStyle {
    ...
    getStyleSheet = (extendedCSS = '', props = {}) => {
        if (this.css) {
            ...
            return `<style type="text/css" data-angulux-style-id="${this.name}" ${_props}>${_style}</style>`;
        }
    ...
    getThemeStyleSheet = (params, props = {}) => {
        ...
        if (this.style) {
            ...
            css.push(`<style type="text/css" data-angulux-style-id="${name}" ${_props}>${_style}</style>`);
        }
