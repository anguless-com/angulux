...
@Component({
    ...
    imports: [IconField, InputIcon, FormsModule],
    template: `
        <agl-iconfield [iconPosition]="position">
...
@Component({
    ...
    imports: [IconField, InputIcon, FormsModule],
    template: `
        <agl-iconfield [styleClass]="customClass">
            <input type="email" [(ngModel)]="email" />
            <agl-inputicon class="pi pi-envelope" />
        </agl-iconfield>
    `
})
...
@Component({
    ...
    standalone: true,
    imports: [IconField, FormsModule],
    template: `<agl-iconfield [pt]="{ root: 'INLINE_STRING' }"><input /></agl-iconfield>`
})
...
@Component({
    ...
    imports: [IconField, FormsModule],
    template: `
        <agl-iconfield><input /></agl-iconfield>
        <agl-iconfield><input /></agl-iconfield>
    `
})
