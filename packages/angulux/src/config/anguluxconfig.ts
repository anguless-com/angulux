...
export class AnguluxConfig extends ThemeProvider {
    ...
    pt = signal<AnguluxConfigType['pt']>(undefined);

    ptOptions = signal<AnguluxConfigType['ptOptions']>(undefined);
    ...
    setConfig(config: AnguluxConfigType): void {
