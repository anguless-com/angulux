...
@Component({
    ...
    template: `
        <div class="severity-buttons">
            <agl-splitbutton label="Primary" severity="primary" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Secondary" severity="secondary" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Success" severity="success" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Info" severity="info" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Warn" severity="warn" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Danger" severity="danger" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Help" severity="help" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Contrast" severity="contrast" [model]="model"></agl-splitbutton>
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div class="variant-buttons">
            <agl-splitbutton label="Raised" [raised]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Rounded" [rounded]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Text" [text]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Outlined" [outlined]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Plain" [plain]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Small" size="small" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Large" size="large" [model]="model"></agl-splitbutton>
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div class="disabled-buttons">
            <agl-splitbutton label="Disabled" [disabled]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Button Disabled" [buttonDisabled]="true" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Menu Disabled" [menuButtonDisabled]="true" [model]="model"></agl-splitbutton>
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div class="icon-buttons">
            <agl-splitbutton icon="pi pi-check" [iconPos]="iconPos" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Save" icon="pi pi-save" iconPos="left" [model]="model"></agl-splitbutton>
            <agl-splitbutton label="Save" icon="pi pi-save" iconPos="right" [model]="model"></agl-splitbutton>
        </div>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-splitbutton label="Custom Dropdown" [dropdownIcon]="dropdownIcon" [model]="model"> </agl-splitbutton> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-splitbutton label="Actions" [model]="model" (onClick)="onMainClick()"></agl-splitbutton> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-splitbutton label="Tooltip Button" [tooltip]="tooltip" [tooltipOptions]="tooltipOptions" [model]="model"> </agl-splitbutton> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-splitbutton label="Autofocus" [autofocus]="autofocus" [model]="model"></agl-splitbutton> `
})
...
describe('SplitButton', () => {
    ...
    beforeEach(async () => {
        ...
        splitButtonElement = fixture.debugElement.query(By.css('agl-splitbutton')).nativeElement;
