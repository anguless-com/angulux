...
@Component({
    ...
    template: `<input type="text" aglAutoFocus />`
})
...
@Component({
    ...
    template: `<input type="text" [aglAutoFocus]="false" />`
})
...
@Component({
    ...
    template: `<input type="text" [aglAutoFocus]="true" />`
})
...
@Component({
    ...
    template: `<input type="text" [aglAutoFocus]="autofocusEnabled" />`
})
...
@Component({
    ...
    template: `<button [aglAutoFocus]="true">Focus Button</button>`
})
...
@Component({
    ...
    template: `<div tabindex="0" [aglAutoFocus]="true">Focusable Div</div>`
})
...
@Component({
    ...
    template: `
        <div [aglAutoFocus]="autofocusEnabled">
...
@Component({
    ...
    template: `
        <div [aglAutoFocus]="true" class="container">
            <div class="nested">
...
@Component({
    ...
    template: `
        <div>
            <input type="text" [aglAutoFocus]="condition1" class="input-1" />
            <input type="text" [aglAutoFocus]="condition2" class="input-2" />
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div [aglAutoFocus]="autofocus" class="dynamic-container">
    ...
    template: `
        ...
        <div class="overlay" *ngIf="isDialogVisible" [style.display]="isDialogVisible ? 'block' : 'none'">
            <div class="dialog-container" role="dialog" [attr.aria-modal]="isDialogVisible">
                ...
                <div class="dialog-content">
                    <input type="text" [aglAutoFocus]="shouldAutoFocus" class="dialog-input" placeholder="This input should be focused when dialog opens" />
                    <textarea [aglAutoFocus]="textareaAutoFocus" class="dialog-textarea" placeholder="Alternative focusable element"></textarea>
        ...
        <div class="drawer" *ngIf="isDrawerVisible" [style.transform]="isDrawerVisible ? 'translateX(0)' : 'translateX(100%)'">
            ...
            <div class="drawer-body">
                <select [aglAutoFocus]="drawerAutoFocus" class="drawer-select">
...
describe('AutoFocus', () => {
    ...
    describe('Directive Initialization', () => {
        ...
        it('should have default values', () => {
            // aglAutoFocus without value defaults to empty string in template, which is truthy
