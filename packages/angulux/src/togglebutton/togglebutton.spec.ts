...
@Component({
    ...
    template: `
        <form [formGroup]="toggleForm">
            <agl-togglebutton formControlName="toggle" [onLabel]="onLabel" [offLabel]="offLabel" (onChange)="onFormToggleChange($event)"> </agl-togglebutton>
        </form>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-togglebutton [(ngModel)]="checked" [onIcon]="onIcon" [offIcon]="offIcon" [iconPos]="iconPos"> </agl-togglebutton> `
})
...
// ToggleButton aglTemplate component
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: true,
...
describe('ToggleButton', () => {
    ...
    describe('ToggleButton aglTemplate Tests', () => {
    ...
    describe('PassThrough (PT) Tests', () => {
        ...
        describe('Case 1: Simple string classes', () => {
            @Component({
                ...
                template: `<agl-togglebutton [(ngModel)]="checked" [pt]="pt"></agl-togglebutton>`
            })
        ...
        describe('Case 2: Objects with class, style, and attributes', () => {
            @Component({
                ...
                standalone: true,
                imports: [ToggleButton, FormsModule],
                template: `<agl-togglebutton [(ngModel)]="checked" onIcon="pi pi-check" offIcon="pi pi-times" [pt]="pt"></agl-togglebutton>`
            })
        ...
        describe('Case 3: Mixed object and string values', () => {
            @Component({
                ...
                standalone: true,
                imports: [ToggleButton, FormsModule],
                template: `<agl-togglebutton [(ngModel)]="checked" onIcon="pi pi-check" [pt]="pt"></agl-togglebutton>`
            })
        ...
        describe('Case 4: Use variables from instance', () => {
            @Component({
                ...
                standalone: true,
                imports: [ToggleButton, FormsModule],
                template: `<agl-togglebutton [(ngModel)]="checked" [disabled]="disabled" [pt]="pt"></agl-togglebutton>`
            })
        ...
        describe('Case 6: Inline PT test', () => {
            it('should apply inline string PT', async () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [ToggleButton, FormsModule],
                    template: `<agl-togglebutton [(ngModel)]="checked" [pt]="{ root: 'INLINE_ROOT_CLASS' }"></agl-togglebutton>`
                })
            ...
            it('should apply inline object PT', async () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [ToggleButton, FormsModule],
                    template: `<agl-togglebutton [(ngModel)]="checked" [pt]="{ root: { class: 'INLINE_OBJECT_CLASS', style: { border: '2px solid red' } } }"></agl-togglebutton>`
                })
        ...
        describe('Case 7: Global PT from AnguluxConfig', () => {
            it('should apply global PT configuration', async () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [ToggleButton, FormsModule],
                    template: `<agl-togglebutton [(ngModel)]="checked1"></agl-togglebutton><agl-togglebutton [(ngModel)]="checked2"></agl-togglebutton>`
                })
