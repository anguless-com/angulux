...
@Component({
    ...
    template: `<agl-chip [label]="label"></agl-chip>`
})
...
@Component({
    ...
    template: `<agl-chip [icon]="icon" [label]="label"></agl-chip>`
})
...
@Component({
    ...
    template: `<agl-chip [image]="image" [alt]="alt" [label]="label" (onImageError)="onImageError($event)"></agl-chip>`
})
...
@Component({
    ...
    template: `<agl-chip [label]="label" [removable]="removable" (onRemove)="onRemove($event)"></agl-chip>`
})
...
@Component({
    ...
    template: `<agl-chip [label]="label" [removable]="removable" [removeIcon]="removeIcon" (onRemove)="onRemove($event)"></agl-chip>`
})
...
@Component({
    ...
    template: `
        <agl-chip [label]="label" [removable]="removable" (onRemove)="onRemove($event)">
...
@Component({
    ...
    template: `<agl-chip [label]="label" [styleClass]="styleClass"></agl-chip>`
})
...
@Component({
    ...
    template: `<agl-chip [chipProps]="chipProps"></agl-chip>`
})
...
@Component({
    ...
    template: `
        <agl-chip [label]="label" [icon]="icon" [image]="image" [alt]="alt" [removable]="removable" [removeIcon]="removeIcon" [styleClass]="styleClass" [chipProps]="chipProps" (onRemove)="onRemove($event)" (onImageError)="onImageError($event)">
...
describe('Chip', () => {
    ...
    describe('PassThrough API', () => {
        @Component({
            ...
            standalone: true,
            imports: [Chip],
            template: `<agl-chip [label]="label()" [icon]="icon()" [image]="image()" [removable]="removable()" [removeIcon]="removeIcon()" [pt]="pt()"></agl-chip>`
        })
