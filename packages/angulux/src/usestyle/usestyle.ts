...
export class UseStyle {
    ...
    use(css, options: any = {}) {
        ...
        styleRef = (this.document.querySelector(`style[data-angulux-style-id="${name}"]`) || (id && this.document.getElementById(id)) || this.document.createElement('style')) as HTMLStyleElement;
