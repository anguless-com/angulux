...
describe('TreeTable', () => {
    ...
    describe('Pagination', () => {
        ...
        it('should display paginator when enabled', async () => {
            const paginator = fixture.debugElement.query(By.css('agl-paginator'));
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-treetable [value]="value" [columns]="columns">
            ...
            <ng-template #body let-rowNode let-rowData="rowData" let-columns="columns">
                <tr [ttRow]="rowNode">
                    <td *ngFor="let col of columns; let i = index" [ttEditableColumn]="rowData" [ttEditableColumnField]="col.field">
                        <agl-treeTableToggler [rowNode]="rowNode" *ngIf="i == 0"></agl-treeTableToggler>
                        {{ rowData[col.field] }}
                    </td>
                </tr>
            </ng-template>
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-treetable #treetable [value]="value" [columns]="columns"> </agl-treetable> `
})
...
// Case 11: Global PT from AnguluxConfig
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    template: `
        <agl-treetable [value]="nodes" [scrollable]="true" scrollHeight="200px" [pt]="{ host: 'INLINE_HOST_CLASS', scrollableWrapper: 'INLINE_WRAPPER_CLASS' }">
            <ng-template #header>
                <tr>
                    <th>Name</th>
                </tr>
...
describe('TreeTable Inline PT', () => {
    ...
    it('should apply inline PT classes', async () => {
        const host = fixture.nativeElement.querySelector('agl-treetable');
        const wrapper = fixture.nativeElement.querySelector('.p-treetable-scrollable-wrapper');
