...
@Component({
    ...
    selector: 'agl-treeTable, agl-treetable, agl-tree-table',
    standalone: false,
    template: `
...
export class TTBody extends BaseComponent {
    @Input('aglTreeTableBody') columns: any[] | undefined;

    @Input('aglTreeTableBodyTemplate') template: Nullable<TemplateRef<any>>;
...
@Component({
    ...
    standalone: false,
    template: `
        <div #scrollHeader [class]="cx('scrollableHeader')" [aglBind]="ptm('scrollableHeader')">
...
@Component({
    selector: 'agl-treeTableCheckbox, agl-treetable-checkbox, agl-tree-table-checkbox',
    standalone: false,
    template: `
...
@Component({
    selector: 'agl-treeTableHeaderCheckbox',
    standalone: false,
    template: `
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    selector: 'agl-treeTableCellEditor, agl-treetablecelleditor, agl-treetable-cell-editor',
    standalone: false,
    template: `
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    selector: 'agl-treeTableToggler, agl-treetabletoggler, agl-treetable-toggler',
    standalone: false,
    template: `
        <button
            type="button"
            [class]="cx('toggler')"
            [aglBind]="ptm('rowToggleButton')"
            (click)="onClick($event)"
            tabindex="-1"
            aglRipple
