...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    selector: 'test-fluid-with-angulux-components',
    template: `
        <agl-fluid>
            <div class="angulux-controls">
...
class TestFluidWithAnguluxComponentsComponent {}
...
describe('Fluid', () => {
    beforeEach(() => {
        TestBed.configureTestingModule({
            ...
            declarations: [
                ...
                TestFluidWithAnguluxComponentsComponent,
    ...
    describe('Component Initialization', () => {
        ...
        it('should have correct selector', () => {
            expect(element.tagName.toLowerCase()).toBe('agl-fluid');
        });
    ...
    describe('Nested Fluid Components', () => {
        ...
        it('should maintain proper hierarchy', () => {
            const outerFluid = element.querySelector('agl-fluid');
            const innerFluid = outerFluid?.querySelector('agl-fluid');
        ...
        it('should apply fluid styling to all levels', () => {
            const fluidElements = element.querySelectorAll('agl-fluid');
    ...
    describe('AnguluxConfig Components Integration', () => {
        let fixture: ComponentFixture<TestFluidWithAnguluxComponentsComponent>;
        let element: HTMLElement;

        beforeEach(() => {
            fixture = TestBed.createComponent(TestFluidWithAnguluxComponentsComponent);
            fixture.detectChanges();
            element = fixture.debugElement.query(By.directive(Fluid)).nativeElement;
        });

        it('should work with AnguluxConfig styled components', () => {
    ...
    describe('PassThrough API', () => {
        @Component({
            ...
            standalone: true,
            imports: [Fluid],
            template: `<agl-fluid [pt]="pt()"><div class="test-content">Test Content</div></agl-fluid>`
        })
