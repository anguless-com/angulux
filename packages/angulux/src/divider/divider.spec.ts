...
@Component({
    ...
    standalone: false,
    template: ` <agl-divider></agl-divider> `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-divider [layout]="layout" [type]="type" [align]="align" [styleClass]="styleClass">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-divider layout="horizontal" type="solid" align="left">
            <b>Left Aligned</b>
        </agl-divider>
        <agl-divider layout="horizontal" type="dashed" align="center">
            <b>Center Aligned</b>
        </agl-divider>
        <agl-divider layout="horizontal" type="dotted" align="right">
            <b>Right Aligned</b>
        </agl-divider>
    `
})
...
@Component({
    ...
    template: `
        <div style="height: 200px; display: flex;">
            ...
            <agl-divider layout="vertical" type="solid" align="top">
                <b>Top</b>
            </agl-divider>
            <div>Middle Content</div>
            <agl-divider layout="vertical" type="dashed" align="center">
                <b>Center</b>
            </agl-divider>
            <div>Right Content</div>
            <agl-divider layout="vertical" type="dotted" align="bottom">
                <b>Bottom</b>
            </agl-divider>
            <div>End Content</div>
        </div>
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-divider [layout]="layout" [type]="type" [align]="align">
...
describe('Divider', () => {
    ...
    describe('PassThrough (PT)', () => {
        ...
        describe('Case 6: Inline test', () => {
            it('should apply inline PT with string class', async () => {
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-divider [pt]="{ root: 'INLINE_ROOT_CLASS' }"></agl-divider>`
                })
            ...
            it('should apply inline PT with object class', async () => {
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-divider [pt]="{ root: { class: 'INLINE_OBJECT_CLASS' } }"></agl-divider>`
                })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            ...
            it('should apply global PT configuration from AnguluxConfig config', async () => {
            ...
            it('should merge local PT with global PT', async () => {
                @Component({
                    changeDetection: ChangeDetectionStrategy.Eager,
                    standalone: false,
                    template: `<agl-divider [pt]="{ root: { class: 'LOCAL_CLASS' } }"></agl-divider>`
                })
