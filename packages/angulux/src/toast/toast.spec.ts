...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-toast [key]="'position-test'" [position]="position"> </agl-toast> `
})
...
describe('Toast', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should create the component', () => {
            ...
            const toast = fixture.debugElement.query(By.css('agl-toast'));
            expect(toast).toBeTruthy();
        });

        it('should have default values', () => {
            const toastEl = fixture.debugElement.query(By.css('agl-toast'));
    ...
    describe('Template Content Projection - Headless approach', () => {
        ...
        it('should handle close callback in headless template', async () => {
            ...
            const toastItemEl = fixture.debugElement.query(By.css('agl-toastitem'));
    ...
    describe('Template Content Projection - aglTemplate approach', () => {
        ...
        it('should process aglTemplate templates correctly', () => {
            const toastEl = fixture.debugElement.query(By.css('agl-toast'));
            const toastInstance = toastEl.componentInstance as Toast;
    ...
    describe('Memory Management and Cleanup', () => {
        ...
        it('should handle multiple component instances', async () => {
            ...
            const toast1El = fixture.debugElement.query(By.css('agl-toast'));
            const toast2El = fixture2.debugElement.query(By.css('agl-toast'));
    ...
    describe('Toast PassThrough - Case 1: Simple string classes', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-toast [key]="'pt-test'" [pt]="pt"></agl-toast> `
        })
        ...
        it('should apply pt host class', async () => {
            ...
            const toastElement = fixture.debugElement.query(By.css('agl-toast'));
    ...
    describe('Toast PassThrough - Case 4: Use variables from instance', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-toast [key]="'pt-test'" [position]="position" [pt]="pt"></agl-toast> `
        })
    ...
    describe('Toast PassThrough - Case 6: Inline test', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-toast [key]="'pt-test'" [pt]="{ host: 'INLINE_HOST_CLASS' }"></agl-toast> `
        })
        ...
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: ` <agl-toast [key]="'pt-test'" [pt]="{ host: { class: 'INLINE_OBJECT_CLASS', style: { border: '2px solid green' } } }"></agl-toast> `
        })
        ...
        it('should apply inline pt with string class', async () => {
            ...
            const toastElement = testFixture.debugElement.query(By.css('agl-toast'));
    ...
    describe('Toast PassThrough - Case 7: Test from AnguluxConfig', () => {
        @Component({
            changeDetection: ChangeDetectionStrategy.Eager,
            standalone: false,
            template: `
                <agl-toast [key]="'toast1'"></agl-toast>
                <agl-toast [key]="'toast2'"></agl-toast>
            `
        })
        ...
        it('should apply global pt configuration from AnguluxConfig', async () => {
            ...
            const toasts = testFixture.debugElement.queryAll(By.css('agl-toast'));
        ...
        it('should merge local pt with global pt configuration', async () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: ` <agl-toast [key]="'pt-test'" [pt]="{ host: 'LOCAL_HOST_CLASS', root: 'LOCAL_ROOT_CLASS' }"></agl-toast> `
            })
