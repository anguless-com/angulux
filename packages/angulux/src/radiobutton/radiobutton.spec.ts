...
@Component({
    ...
    imports: [RadioButton, FormsModule],
    template: `
        <agl-radiobutton name="group" value="option1" [(ngModel)]="selectedOption" inputId="option1" />
        <agl-radiobutton name="group" value="option2" [(ngModel)]="selectedOption" inputId="option2" />
        <agl-radiobutton name="group" value="option3" [(ngModel)]="selectedOption" inputId="option3" />
    `
})
...
@Component({
    ...
    template: `
        <form [formGroup]="radioForm">
            <agl-radiobutton formControlName="selectedValue" name="radioGroup" value="value1" inputId="radio1" [invalid]="isInvalid" />
            <agl-radiobutton formControlName="selectedValue" name="radioGroup" value="value2" inputId="radio2" [invalid]="isInvalid" />
            <agl-radiobutton formControlName="selectedValue" name="radioGroup" value="value3" inputId="radio3" [invalid]="isInvalid" />
        </form>
    `
})
...
@Component({
    ...
    standalone: true,
    imports: [RadioButton, FormsModule],
    template: ` <agl-radiobutton name="advanced" [value]="radioValue" [(ngModel)]="selectedValue" [disabled]="isDisabled" [binary]="binary" [variant]="variant" [size]="size" [autofocus]="autofocus" (onClick)="onAdvancedClick($event)" /> `
})
...
@Component({
    ...
    standalone: true,
    imports: [RadioButton, FormsModule],
    template: ` <agl-radiobutton name="binary" value="binary-value" [(ngModel)]="binaryValue" [binary]="true" /> `
})
    ...
    describe('PassThrough (PT) Tests', () => {
        describe('Case 1: Simple string classes', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-radiobutton name="test" value="option1" [(ngModel)]="selectedValue" [pt]="pt"></agl-radiobutton>`
            })
        ...
        describe('Case 6: Inline PT', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-radiobutton name="test" value="option1" [(ngModel)]="selectedValue" [pt]="{ root: 'INLINE_ROOT_CLASS', box: 'INLINE_BOX_CLASS' }"></agl-radiobutton>`
            })
            ...
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-radiobutton name="test" value="option1" [(ngModel)]="selectedValue" [pt]="{ root: { class: 'INLINE_OBJECT_CLASS' }, box: { class: 'BOX_INLINE_CLASS' } }"></agl-radiobutton>`
            })
        ...
        describe('Case 7: Global PT from AnguluxConfig', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-radiobutton name="test" value="option1" [(ngModel)]="selectedValue"></agl-radiobutton>`
            })
