...
@Component({
    ...
    template: `
        <agl-iconfield>
            ...
            <input type="text" aglInputText [(ngModel)]="value" placeholder="Search" />
        </agl-iconfield>
    `
})
...
@Component({
    ...
    template: `
        <agl-iconfield>
            <agl-inputicon [styleClass]="customClass" class="pi pi-user" />
            <input type="text" aglInputText [(ngModel)]="username" />
        </agl-iconfield>
    `
})
