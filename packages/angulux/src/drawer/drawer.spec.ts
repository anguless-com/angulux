...
@Component({
    ...
    imports: [Drawer],
    template: `
        <agl-drawer [(visible)]="visible" [position]="position">
...
@Component({
    ...
    imports: [Drawer],
    template: `
        <agl-drawer [(visible)]="visible" [fullScreen]="fullScreen">
...
@Component({
    ...
    imports: [Drawer],
    template: `
        <agl-drawer [(visible)]="visible" [modal]="modal" [dismissible]="dismissible">
...
@Component({
    ...
    imports: [Drawer],
    template: `
        <agl-drawer [(visible)]="visible" [closable]="closable" [closeOnEscape]="closeOnEscape" [ariaCloseLabel]="ariaCloseLabel">
...
describe('Drawer', () => {
    ...
    describe('Component Initialization', () => {
        ...
        it('should initialize component correctly', () => {
            const drawerElement = testFixture.debugElement.query(By.css('agl-drawer'));
    ...
    describe('Template Support', () => {
        it('should support aglTemplate header template', async () => {
        ...
        it('should support aglTemplate content template', async () => {
            const testFixture = TestBed.createComponent(TestDrawerTemplatesComponent);
            const testComponent = testFixture.componentInstance;
            testFixture.changeDetectorRef.markForCheck();
            await testFixture.whenStable();
        ...
        it('should support aglTemplate footer template', async () => {
            const testFixture = TestBed.createComponent(TestDrawerTemplatesComponent);
            const testComponent = testFixture.componentInstance;
            testFixture.changeDetectorRef.markForCheck();
            await testFixture.whenStable();
        ...
        it('should support aglTemplate closeicon template', async () => {
            const testFixture = TestBed.createComponent(TestDrawerTemplatesComponent);
            const testComponent = testFixture.componentInstance;
            testFixture.changeDetectorRef.markForCheck();
            await testFixture.whenStable();
    ...
    describe('PT (PassThrough) Tests', () => {
        describe('Case 1: Simple string classes', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-drawer [pt]="pt" [(visible)]="visible" header="Test Drawer">Content</agl-drawer>`
            })
        ...
        describe('Case 4: Use variables from instance', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-drawer [pt]="pt" [(visible)]="visible" [position]="position" header="Test Drawer">Content</agl-drawer>`
            })
        ...
        describe('Case 6: Inline test', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-drawer [pt]="{ root: 'INLINE_ROOT_CLASS', header: 'INLINE_HEADER_CLASS' }" [(visible)]="visible" header="Test Drawer">Content</agl-drawer>`
            })
            ...
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-drawer [pt]="{ root: { class: 'INLINE_ROOT_OBJECT_CLASS' }, content: { class: 'INLINE_CONTENT_CLASS' } }" [(visible)]="visible" header="Test Drawer">Content</agl-drawer>`
            })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-drawer [(visible)]="visible1" header="Drawer 1">Content 1</agl-drawer>
                    <agl-drawer [(visible)]="visible2" header="Drawer 2">Content 2</agl-drawer>
                `
            })
