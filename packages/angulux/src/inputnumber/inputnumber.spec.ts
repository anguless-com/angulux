...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-inputNumber formControlName="numberField" [showButtons]="showButtons" [min]="min" [max]="max" [step]="step"></agl-inputNumber>
        </form>
    `
})
...
// InputNumber aglTemplate component
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `
...
describe('InputNumber', () => {
    ...
    describe('Number Validation and Formatting', () => {
        ...
        it('should respect min and max constraints', () => {
            ...
            const inputNumberInstance = testFixture.debugElement.query(By.css('agl-inputNumber')).componentInstance;
    ...
    describe('InputNumber aglTemplate Tests', () => {
        ...
        beforeEach(() => {
            ...
            inputNumberElement = templateFixture.debugElement.query(By.css('agl-inputNumber'));
        ...
        it('should have clearicon aglTemplate', () => {
        ...
        it('should have incrementbuttonicon aglTemplate', () => {
            const inputNumberComponent = inputNumberElement.componentInstance;
            expect(inputNumberComponent).toBeTruthy();
            expect(() => inputNumberComponent.incrementButtonIconTemplate).not.toThrow();
        });

        it('should have decrementbuttonicon aglTemplate', () => {
            const inputNumberComponent = inputNumberElement.componentInstance;
            expect(inputNumberComponent).toBeTruthy();
        ...
        it('should render custom clear icon aglTemplate when showClear is enabled', () => {
            templateFixture.detectChanges();
        ...
        it('should render custom increment icon aglTemplate when showButtons is enabled', () => {
            templateFixture.detectChanges();
        ...
        it('should render custom decrement icon aglTemplate when showButtons is enabled', () => {
            templateFixture.detectChanges();
    ...
    describe('PassThrough (PT) Tests', () => {
        describe('Case 1: Simple string classes', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-inputNumber [(ngModel)]="value" [showButtons]="true" [pt]="pt"></agl-inputNumber>`
            })
        ...
        describe('Case 6: Inline PT', () => {
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-inputNumber [(ngModel)]="value" [pt]="{ root: 'INLINE_ROOT_CLASS', pcInputText: { root: 'INLINE_INPUT_CLASS' } }" [showButtons]="true"></agl-inputNumber>`
            })
            ...
            @Component({
                changeDetection: ChangeDetectionStrategy.Eager,
                standalone: false,
                template: `<agl-inputNumber [(ngModel)]="value" [pt]="{ root: { class: 'INLINE_ROOT_OBJECT_CLASS' }, pcInputText: { root: { class: 'INLINE_INPUT_OBJECT_CLASS' } } }" [showButtons]="true"></agl-inputNumber>`
            })
        ...
        describe('Case 7: Global PT from AnguluxConfig', () => {
            @Component({
                ...
                standalone: false,
                template: `
                    <agl-inputNumber [(ngModel)]="value1" [showButtons]="true"></agl-inputNumber>
                    <agl-inputNumber [(ngModel)]="value2" [showButtons]="true"></agl-inputNumber>
                `
            })
