...
@Component({
    ...
    standalone: false,
    template: `<agl-tieredmenu [model]="model" [styleClass]="styleClass" [style]="style" [popup]="popup" [disabled]="disabled" [autoDisplay]="autoDisplay"></agl-tieredmenu>`
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-tieredmenu #menu [model]="model" [popup]="true"></agl-tieredmenu>
...
@Component({
    ...
    template: `<agl-tieredmenu [model]="model"></agl-tieredmenu>`
})
...
@Component({
    ...
    template: `<agl-tieredmenu [model]="model" [breakpoint]="breakpoint"></agl-tieredmenu>`
})
...
describe('TieredMenu', () => {
    ...
    beforeEach(async () => {
        ...
        tieredMenuElement = fixture.debugElement.query(By.css('agl-tieredmenu')).nativeElement;
    ...
    describe('Menu Display and Interaction', () => {
        ...
        it('should display submenu items', () => {
            ...
            const submenu = firstMenuItem.query(By.css('agl-tieredmenusub'));
    ...
    describe('Templates', () => {
        ...
        it('should render different template types correctly', async () => {
            // Test both aglTemplate and #item template approaches
        ...
        it('should render custom submenu icon template with aglTemplate', async () => {
    ...
    describe('Tooltip', () => {
        it('should spawn a tooltip if an option has one provided', async () => {
            ...
            // All <li> elements that have the aglTooltip directive attached
            ...
            // `content` is the @Input('aglTooltip') property set directly by Angular
    ...
    describe('PassThrough', () => {
        ...
        describe('Case 1: Simple string classes', () => {
            @Component({
                ...
                standalone: true,
                imports: [TieredMenu],
                template: `<agl-tieredmenu [model]="model" [pt]="pt"></agl-tieredmenu>`
            })
        ...
        describe('Case 4: Use variables from instance', () => {
            @Component({
                ...
                standalone: true,
                imports: [TieredMenu],
                template: `<agl-tieredmenu [model]="model" [pt]="pt" [disabled]="disabled"></agl-tieredmenu>`
            })
        ...
        describe('Case 7: Test from AnguluxConfig', () => {
            @Component({
                ...
                imports: [TieredMenu],
                template: `
                    <agl-tieredmenu [model]="model1"></agl-tieredmenu>
                    <agl-tieredmenu [model]="model2"></agl-tieredmenu>
                `
            })
        ...
        describe('Inline PT tests', () => {
            ...
            it('should apply inline PT with string', async () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [TieredMenu],
                    template: `<agl-tieredmenu [model]="model" [pt]="{ root: 'INLINE_STRING_CLASS' }"></agl-tieredmenu>`
                })
            ...
            it('should apply inline PT with object', async () => {
                @Component({
                    ...
                    standalone: true,
                    imports: [TieredMenu],
                    template: `<agl-tieredmenu [model]="model" [pt]="{ root: { class: 'INLINE_OBJECT_CLASS' } }"></agl-tieredmenu>`
                })
