...
@Component({
    ...
    standalone: false,
    template: `<agl-progressbar [value]="value" [showValue]="showValue" [unit]="unit" [mode]="mode" [color]="color" [valueStyleClass]="valueStyleClass" [styleClass]="styleClass"> </agl-progressbar>`
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<agl-progressbar [value]="value" mode="indeterminate"></agl-progressbar>`
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: `<agl-progressbar [value]="value" [style]="style" [styleClass]="styleClass"></agl-progressbar>`
})
...
describe('ProgressBar', () => {
    ...
    describe('PassThrough API', () => {
        @Component({
            ...
            standalone: true,
            imports: [ProgressBar],
            template: `<agl-progressbar [value]="value()" [mode]="mode()" [showValue]="showValue()" [unit]="unit()" [color]="color()" [pt]="pt()"></agl-progressbar>`
        })
