...
@Component({
    ...
    template: `<agl-badge [value]="value"></agl-badge>`
})
...
@Component({
    ...
    template: `<agl-badge [badgeSize]="badgeSize" value="1"></agl-badge>`
})
...
@Component({
    ...
    template: `<agl-badge [severity]="severity" value="1"></agl-badge>`
})
...
@Component({
    ...
    template: `<agl-badge [badgeDisabled]="disabled" value="1"></agl-badge>`
})
...
@Component({
    ...
    template: `<agl-badge [styleClass]="styleClass" value="1"></agl-badge>`
})
...
@Component({
    ...
    template: `<button #button aglBadge [value]="value">Button</button>`
})
...
@Component({
    ...
    template: `<button aglBadge [value]="value" [size]="size">Button</button>`
})
...
@Component({
    ...
    template: `<button aglBadge [value]="value" [severity]="severity">Button</button>`
})
...
@Component({
    ...
    template: `<button aglBadge [value]="value" [badgeDisabled]="disabled">Button</button>`
})
...
@Component({
    ...
    template: `<button aglBadge [value]="value" [badgeStyle]="badgeStyle" [badgeStyleClass]="badgeStyleClass">Button</button>`
})
...
@Component({
    ...
    template: ` <agl-badge [value]="value" [badgeSize]="badgeSize" [severity]="severity" [badgeDisabled]="disabled" [styleClass]="styleClass"> </agl-badge> `
})
...
describe('Badge', () => {
    ...
    describe('PassThrough API', () => {
        @Component({
            ...
            standalone: true,
            imports: [Badge],
            template: `<agl-badge [value]="value()" [badgeSize]="badgeSize()" [severity]="severity()" [pt]="pt()"></agl-badge>`
        })
