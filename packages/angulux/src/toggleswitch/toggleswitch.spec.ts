...
describe('ToggleSwitch', () => {
    ...
    describe('Event Handling', () => {
        ...
        it('should focus input element after click', () => {
            const toggleSwitch = testFixture.debugElement.query(By.css('agl-toggleswitch')).componentInstance;
    ...
    describe('Accessibility', () => {
        ...
        it('should update aria-checked when state changes', () => {
            const toggleSwitchComponent = testFixture.debugElement.query(By.css('agl-toggleswitch')).componentInstance;
        ...
        it('should support autofocus', async () => {
            ...
            const input = testFixture.debugElement.query(By.css('input'));
            if (input) {
                // Check if the aglAutoFocus directive is applied
                const hasAutoFocus = input.nativeElement.hasAttribute('aglautofocus') || input.nativeElement.hasAttribute('autofocus') || testComponent.autofocus === true;
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-toggleswitch [(ngModel)]="checked" [readonly]="readonly" [disabled]="disabled" [autofocus]="autofocus" [ariaLabel]="ariaLabel" [ariaLabelledBy]="ariaLabelledBy" [tabindex]="tabindex" (onChange)="onToggleChange($event)"> </agl-toggleswitch>
    `
})
...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-toggleswitch formControlName="toggleValue"></agl-toggleswitch>
        </form>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-toggleswitch [required]="required"></agl-toggleswitch> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-toggleswitch [name]="name"></agl-toggleswitch> `
})
class TestNamedToggleSwitchComponent {
    name: string = '';
}

// ToggleSwitch aglTemplate component
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: true,
...
describe('ToggleSwitch aglTemplate Tests', () => {
    ...
    it('should create component with aglTemplate templates', async () => {
        expect(component).toBeTruthy();
        expect(toggleSwitchInstance).toBeTruthy();
...
describe('PassThrough (PT) Tests', () => {
    ...
    describe('Case 1: Simple string classes', () => {
        @Component({
            ...
            template: `<agl-toggleswitch [(ngModel)]="checked" [pt]="pt"></agl-toggleswitch>`
        })
    ...
    describe('Case 4: Use variables from instance', () => {
        @Component({
            ...
            standalone: true,
            imports: [ToggleSwitch, FormsModule],
            template: `<agl-toggleswitch [(ngModel)]="checked" [disabled]="disabled" [pt]="pt"></agl-toggleswitch>`
        })
    ...
    describe('Case 6: Inline PT test', () => {
        it('should apply inline string PT', async () => {
            @Component({
                ...
                standalone: true,
                imports: [ToggleSwitch, FormsModule],
                template: `<agl-toggleswitch [(ngModel)]="checked" [pt]="{ root: 'INLINE_ROOT_CLASS' }"></agl-toggleswitch>`
            })
        ...
        it('should apply inline object PT', async () => {
            @Component({
                ...
                standalone: true,
                imports: [ToggleSwitch, FormsModule],
                template: `<agl-toggleswitch [(ngModel)]="checked" [pt]="{ root: { class: 'INLINE_OBJECT_CLASS', style: { border: '2px solid red' } } }"></agl-toggleswitch>`
            })
    ...
    describe('Case 7: Global PT from AnguluxConfig', () => {
        it('should apply global PT configuration', async () => {
            @Component({
                ...
                standalone: true,
                imports: [ToggleSwitch, FormsModule],
                template: `<agl-toggleswitch [(ngModel)]="checked1"></agl-toggleswitch><agl-toggleswitch [(ngModel)]="checked2"></agl-toggleswitch>`
            })
