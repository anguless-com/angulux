...
import { ToggleSwitchChangeEvent, ToggleSwitchHandleTemplateContext, ToggleSwitchPassThrough } from '@anguless/angulux/types/toggleswitch';
 ...
 */
@Component({
    selector: 'agl-toggleswitch, agl-toggleSwitch, agl-toggle-switch',
    standalone: true,
