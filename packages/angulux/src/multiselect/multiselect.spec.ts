...
import type { MultiSelectBlurEvent, MultiSelectChangeEvent, MultiSelectFilterEvent, MultiSelectFocusEvent } from '@anguless/angulux/types/multiselect';
interface City {
    name: string;
    code: string;
    country?: string;
...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-multiselect formControlName="selectedCities" [options]="options" optionLabel="name" placeholder="Select Cities" [showClear]="true" [filter]="true"></agl-multiselect>
        </form>
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-multiselect [options]="groupedOptions" [(ngModel)]="selectedCities" [group]="true" optionLabel="name" optionGroupLabel="label" optionGroupChildren="items" placeholder="Select Cities"></agl-multiselect> `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-multiselect [options]="options" [(ngModel)]="selectedCities" optionLabel="name" [virtualScroll]="true" [virtualScrollItemSize]="40" [scrollHeight]="'200px'" [lazy]="lazy" (onLazyLoad)="onLazyLoad($event)"></agl-multiselect> `
})
...
describe('MultiSelect', () => {
    ...
    describe('CSS Classes and Styling', () => {
        it('should apply basic CSS classes', () => {
            const multiSelectElement = fixture.debugElement.query(By.css('agl-multiselect'));
        ...
        it('should apply custom styles', () => {
            ...
            const element = fixture.debugElement.query(By.css('agl-multiselect')).nativeElement;
            if (component.style) {
        ...
        it('should display selected items as chips', async () => {
            ...
            const chip = fixture.debugElement.query(By.css('agl-chip'));
...
describe('MultiSelect Grouped Options', () => {
    ...
    it('should render options under groups', async () => {
        ...
        const options = fixture.debugElement.queryAll(By.css('li[aglMultiSelectItem]'));
...
describe('MultiSelect Virtual Scrolling', () => {
    ...
    it('should handle large datasets', async () => {
        ...
        const scroller = fixture.debugElement.query(By.css('agl-scroller'));
...
@Component({
    ...
    template: `
        <div class="test-dynamic-data">
            ...
            <agl-multiselect #getterMultiSelect [options]="getCities()" [(ngModel)]="selectedCitiesGetter" optionLabel="name" [placeholder]="getPlaceholder()" [disabled]="getDisabled()" class="getter-multiselect"></agl-multiselect>
            ...
            <agl-multiselect #lateLoadMultiSelect [options]="lateLoadedOptions" [(ngModel)]="selectedCitiesLateLoad" optionLabel="name" [loading]="isLoadingLateData" [placeholder]="lateLoadPlaceholder" class="late-load-multiselect"></agl-multiselect>
    ...
    template: `
        <div class="comprehensive-form-tests">
            ...
            <form [formGroup]="reactiveForm" class="reactive-form">
                <agl-multiselect #reactiveMultiSelect formControlName="cities" [options]="allCities" optionLabel="name" placeholder="Select cities (Reactive)" [showClear]="true" [filter]="true" class="reactive-multiselect"></agl-multiselect>

                <agl-multiselect #validatedMultiSelect formControlName="validatedCities" [options]="allCities" optionLabel="name" placeholder="Required cities (Reactive)" [showClear]="true" [filter]="true" class="validated-multiselect"></agl-multiselect>
            </form>
...
@Component({
    ...
    template: `
        <div class="edge-cases-tests">
            ...
            <agl-multiselect #unicodeMultiSelect [options]="unicodeOptions" [(ngModel)]="selectedUnicode" optionLabel="name" placeholder="Unicode & Special chars" [filter]="true" class="unicode-multiselect"></agl-multiselect>

            <!-- XSS protection test -->
            <agl-multiselect #xssMultiSelect [options]="xssTestOptions" [(ngModel)]="selectedXss" optionLabel="name" placeholder="XSS Protection Test" [filter]="true" class="xss-multiselect"></agl-multiselect>
            ...
            <agl-multiselect #nullHandlingMultiSelect [options]="nullTestOptions" [(ngModel)]="selectedNull" optionLabel="name" placeholder="Null handling test" class="null-handling-multiselect"></agl-multiselect>

            <!-- Circular reference test -->
            <agl-multiselect #circularMultiSelect [options]="circularOptions" [(ngModel)]="selectedCircular" optionLabel="name" placeholder="Circular reference test" class="circular-multiselect"></agl-multiselect>
        </div>
    `
})
