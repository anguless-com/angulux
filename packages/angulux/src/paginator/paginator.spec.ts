...
@Component({
    ...
    standalone: false,
    template: `
        <agl-paginator [rows]="10" [totalRecords]="100" [first]="0" [rowsPerPageOptions]="[5, 10, 20]">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-paginator [rows]="10" [totalRecords]="100" [first]="0" [showJumpToPageDropdown]="true" [jumpToPageItemTemplate]="jumpTemplate" [dropdownItemTemplate]="dropdownTemplate" [rowsPerPageOptions]="rowsPerPageOptions">
...
describe('Paginator', () => {
    ...
    describe('CSS and Styling', () => {
        it('should apply correct CSS classes', () => {
            const paginatorElement = fixture.debugElement.query(By.css('agl-paginator'));
