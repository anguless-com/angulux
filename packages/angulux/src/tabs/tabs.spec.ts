...
@Component({
    ...
    standalone: false,
    template: `
        <agl-tabs [(value)]="value" [scrollable]="scrollable" [lazy]="lazy" [selectOnFocus]="selectOnFocus" [showNavigators]="showNavigators" [tabindex]="tabindex">
            <agl-tablist>
                <agl-tab [value]="1">Tab 1</agl-tab>
                <agl-tab [value]="2">Tab 2</agl-tab>
                <agl-tab [value]="3" [disabled]="tab3Disabled">Tab 3</agl-tab>
            </agl-tablist>
            <agl-tabpanels>
    ...
    template: `
        <agl-tabs [(value)]="value" [scrollable]="true">
            <agl-tablist>
                ...
                <agl-tab [value]="2">Very Long Tab Name 2</agl-tab>
                <agl-tab [value]="3">Very Long Tab Name 3</agl-tab>
                <agl-tab [value]="4">Very Long Tab Name 4</agl-tab>
                <agl-tab [value]="5">Very Long Tab Name 5</agl-tab>
                <agl-tab [value]="6">Very Long Tab Name 6</agl-tab>
            </agl-tablist>
            <agl-tabpanels>
                <agl-tabpanel [value]="1">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-tabs [(value)]="value" [lazy]="true">
            <agl-tablist>
                <agl-tab [value]="1">Lazy Tab 1</agl-tab>
                <agl-tab [value]="2">Lazy Tab 2</agl-tab>
                <agl-tab [value]="3">Lazy Tab 3</agl-tab>
            </agl-tablist>
            <agl-tabpanels>
                <agl-tabpanel [value]="1">
    ...
    template: `
        <agl-tabs [(value)]="value" [scrollable]="true">
            <agl-tablist>
                ...
                <agl-tab [value]="1">Tab with ContentChild Icons 1</agl-tab>
                <agl-tab [value]="2">Tab with ContentChild Icons 2</agl-tab>
                <agl-tab [value]="3">Tab with ContentChild Icons 3</agl-tab>
                <agl-tab [value]="4">Tab with ContentChild Icons 4</agl-tab>
                <agl-tab [value]="5">Tab with ContentChild Icons 5</agl-tab>
                <agl-tab [value]="6">Tab with ContentChild Icons 6</agl-tab>
            </agl-tablist>
            <agl-tabpanels>
                <agl-tabpanel [value]="1">
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-tabs [value]="1" [pt]="pt">
            <agl-tablist>
                <agl-tab [value]="1">PT Test Tab 1</agl-tab>
                <agl-tab [value]="2">PT Test Tab 2</agl-tab>
            </agl-tablist>
            <agl-tabpanels>
                <agl-tabpanel [value]="1">
...
describe('Tabs', () => {
    ...
    describe('Tab List Rendering', () => {
        it('should render tab list', () => {
            const tabList = fixture.debugElement.query(By.css('agl-tablist'));
            expect(tabList).toBeTruthy();
        });

        it('should render all tabs', () => {
            const tabElements = fixture.debugElement.queryAll(By.css('agl-tab'));
        ...
        it('should have correct ARIA roles', () => {
            ...
            const tabButtons = fixture.debugElement.queryAll(By.css('agl-tab button'));
            const tabs = fixture.debugElement.queryAll(By.css('agl-tab'));
    ...
    describe('Tab Panel Rendering', () => {
        it('should render tab panels container', () => {
            const tabPanels = fixture.debugElement.query(By.css('agl-tabpanels'));
            expect(tabPanels).toBeTruthy();
        });

        it('should render all tab panels', () => {
            const panels = fixture.debugElement.queryAll(By.css('agl-tabpanel'));
        ...
        it('should have correct ARIA attributes on panels', () => {
            const tabPanels = fixture.debugElement.queryAll(By.css('agl-tabpanel'));
    ...
    describe('Tab Navigation', () => {
        it('should activate tab on click', async () => {
            const tab2 = fixture.debugElement.queryAll(By.css('agl-tab'))[1];
    ...
    describe('Disabled Tabs', () => {
        it('should disable specific tabs', async () => {
            ...
            const tab3 = fixture.debugElement.queryAll(By.css('agl-tab'))[2];
        ...
        it('should set correct ARIA attributes for disabled tabs', async () => {
            ...
            const tab3 = fixture.debugElement.queryAll(By.css('agl-tab'))[2];
            const tab3Button = fixture.debugElement.queryAll(By.css('agl-tab'))[2].query(By.css('button'));
    ...
    describe('Keyboard Navigation', () => {
        ...
        beforeEach(() => {
            tabs = fixture.debugElement.queryAll(By.css('agl-tab'));
            // Focus first tab
    ...
    describe('Navigation Icon Templates', () => {
        describe('aglTemplate Navigation Icons', () => {
            let scrollableFixture: ComponentFixture<TestScrollableTabsComponent>;
            ...
            it('should render custom prev icon with aglTemplate', () => {
                const customPrevIcon = scrollableFixture.debugElement.query(By.css('.custom-prev-icon'));
            ...
            it('should render custom next icon with aglTemplate', () => {
                const customNextIcon = scrollableFixture.debugElement.query(By.css('.custom-next-icon'));
        ...
        describe('ContentChild Navigation Icons (#previcon/#nexticon)', () => {
            ...
            it('should support both ContentChild and aglTemplate approaches', () => {
            ...
            it('should maintain scrollable functionality with custom icons', () => {
                const tabList = contentChildFixture.debugElement.query(By.directive(TabList));
                const tabs = contentChildFixture.debugElement.queryAll(By.css('agl-tab'));
    ...
    describe('CSS Classes and Styling', () => {
        it('should apply correct CSS classes', () => {
            const tabsElement = fixture.debugElement.query(By.css('agl-tabs'));
            const tabListElement = fixture.debugElement.query(By.css('agl-tablist'));
            const tabElements = fixture.debugElement.queryAll(By.css('agl-tab'));
    ...
    describe('Data Attributes', () => {
        ...
        it('should update data attributes on state change', async () => {
            ...
            const tab2 = fixture.debugElement.queryAll(By.css('agl-tab'))[1];
            const panel2 = fixture.debugElement.queryAll(By.css('agl-tabpanel'))[1];
    ...
    describe('PassThrough', () => {
        ...
        it('should apply simple string classes to PT sections', async () => {
            ...
            const tabsEl = ptFixture.debugElement.query(By.css('agl-tabs'));
