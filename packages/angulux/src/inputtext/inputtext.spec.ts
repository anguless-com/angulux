...
@Component({
    ...
    template: ` <input type="text" aglInputText [(ngModel)]="value" placeholder="Enter text" /> `
})
...
@Component({
    ...
    standalone: true,
    imports: [InputText, FormsModule],
    template: ` <input type="text" aglInputText [(ngModel)]="content" [aglSize]="size" [variant]="variant" [fluid]="fluid" [invalid]="invalid" placeholder="Advanced input" /> `
})
...
@Component({
    ...
    template: ` <input type="email" aglInputText [formControl]="emailControl" /> `
})
...
@Component({
    ...
    standalone: true,
    imports: [InputText, FormsModule],
    template: ` <input type="password" aglInputText [(ngModel)]="password" /> `
})
...
@Component({
    ...
    standalone: true,
    imports: [InputText, FormsModule],
    template: ` <input type="text" aglInputText [pt]="pt" [invalid]="invalid" [fluid]="fluid" [variant]="variant" [(ngModel)]="value" /> `
})
...
describe('InputText', () => {
    describe('Basic Functionality', () => {
        ...
        it('should apply aglInputText directive', () => {
        ...
        it('should have input element with directive applied', () => {
            expect(inputEl.nativeElement.hasAttribute('aglInputText')).toBe(true);
        });
    ...
    describe('Advanced Features', () => {
        ...
        it('should apply size variants', async () => {
            ...
            expect(inputDirective.aglSize).toBe('large');

            component.size = 'small';
            fixture.changeDetectorRef.markForCheck();
            await fixture.whenStable();

            expect(inputDirective.aglSize).toBe('small');
        });
