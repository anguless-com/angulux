...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-selectbutton [options]="options" formControlName="selectedValue"> </agl-selectbutton>
        </form>
    `
})
...
// SelectButton aglTemplate component
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: true,
...
describe('SelectButton aglTemplate Tests', () => {
...
describe('SelectButton PassThrough Tests', () => {
    ...
    describe('PT Case 6: Inline PT', () => {
        it('should work with inline string PT', () => {
            ...
            const inlineHostElement = inlineFixture.nativeElement.querySelector('agl-selectbutton');
    ...
    describe('PT Case 7: Global PT from AnguluxConfig', () => {
        ...
        it('should apply global PT to multiple component instances', async () => {
            ...
            const selectButtons = multiFixture.nativeElement.querySelectorAll('agl-selectbutton');
    ...
    describe('PT Case 9: pcToggleButton passthrough', () => {
        it('should pass PT options to child ToggleButton component', () => {
            ...
            const toggleButtons = hostElement.querySelectorAll('agl-togglebutton');
...
@Component({
    ...
    template: `<agl-selectbutton [options]="options" [pt]="{ root: 'INLINE_STRING' }" />`
})
...
@Component({
    ...
    standalone: true,
    imports: [SelectButton, FormsModule, CommonModule],
    template: `<agl-selectbutton [options]="options" [pt]="{ root: { class: 'INLINE_OBJECT_CLASS', 'data-inline': 'true' } }" />`
})
...
@Component({
    ...
    imports: [SelectButton, FormsModule, CommonModule],
    template: `
        <agl-selectbutton [options]="options1" />
        <agl-selectbutton [options]="options2" />
    `
})
