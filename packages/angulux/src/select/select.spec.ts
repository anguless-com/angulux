...
import { settled, waitUntil } from '../spec-helpers';
...
@Component({
    ...
    template: `
        <form [formGroup]="form">
            <agl-select formControlName="selectedOption" [options]="options" optionLabel="name" optionValue="code" placeholder="Choose an option"> </agl-select>
        </form>
    `
})
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-select [options]="groupedOptions" [(ngModel)]="selectedCity" optionLabel="cname" optionValue="code" [group]="true" optionGroupLabel="label" optionGroupChildren="items" placeholder="Select a city"> </agl-select> `
})
...
@Component({
    ...
    standalone: false,
    template: `
        <agl-select [options]="options" [(ngModel)]="selectedValue" optionLabel="name" optionValue="code" placeholder="Select with template refs" [filter]="filter" [showClear]="showClear" [loading]="loading">
            <ng-template #item let-option>
                <div class="ref-item">
...
@Component({
    changeDetection: ChangeDetectionStrategy.Eager,
    standalone: false,
    template: ` <agl-select [options]="dynamicOptions()" [(ngModel)]="selectedValue" optionLabel="label" optionValue="value" [placeholder]="dynamicPlaceholder()" [disabled]="dynamicDisabled()" [loading]="dynamicLoading()"> </agl-select> `
})
...
@Component({
    ...
    template: `
        <div class="dynamic-test-container">
            ...
            <agl-select #getterSelect class="getter-select" [options]="getterOptions" [(ngModel)]="selectedGetter" [optionLabel]="getterLabel" [optionValue]="getterValue" [placeholder]="getterPlaceholder" (onChange)="onGetterChange($event)"></agl-select>
            ...
            <agl-select #computedSelect class="computed-select" [options]="computedOptions()" [(ngModel)]="selectedComputed" [optionLabel]="computedLabel()" [placeholder]="computedPlaceholder()" (onChange)="onComputedChange($event)"></agl-select>
        </div>
    `
})
    ...
    template: `
        <div class="form-test-container">
            <form [formGroup]="testForm">
                ...
                <agl-select #basicFormSelect formControlName="basicSelect" [options]="basicOptions" optionLabel="name" optionValue="code" placeholder="Basic reactive select"></agl-select>

                <!-- Disabled form control -->
                <agl-select #disabledFormSelect formControlName="disabledSelect" [options]="basicOptions" optionLabel="name" placeholder="Disabled select"></agl-select>

                <!-- Validators test -->
                <agl-select #validatedFormSelect formControlName="validatedSelect" [options]="basicOptions" optionLabel="name" optionValue="code" placeholder="Select with validation"></agl-select>

                <!-- UpdateOn blur -->
                <agl-select #updateOnBlurSelect formControlName="updateOnBlurSelect" [options]="basicOptions" optionLabel="name" placeholder="Update on blur"></agl-select>

                <!-- Nested form group -->
                <div formGroupName="nested">
                    <agl-select #nestedFormSelect formControlName="nestedSelect" [options]="basicOptions" optionLabel="name" placeholder="Nested form select"></agl-select>
                </div>
            </form>

            <!-- NgModel test -->
            <agl-select #ngModelSelect [(ngModel)]="ngModelValue" [options]="basicOptions" optionLabel="name" optionValue="code" placeholder="NgModel select" #ngModelRef="ngModel" name="ngModelSelect"></agl-select>
...
@Component({
    ...
    template: `
        <div class="viewchild-test-container">
            <agl-select #testSelect [options]="options" [(ngModel)]="selectedValue" optionLabel="name" optionValue="code" placeholder="ViewChild test select" [filter]="true" [showClear]="true" [virtualScroll]="false"></agl-select>

            <agl-select #virtualSelect [options]="largeOptions" [(ngModel)]="selectedVirtual" optionLabel="name" optionValue="code" placeholder="Virtual scroll select" [virtualScroll]="true" [virtualScrollItemSize]="38" [scrollHeight]="200"></agl-select>
        </div>
    `
})
...
@Component({
    ...
    template: `
        <div class="edge-cases-container">
            <!-- Rapid updates test -->
            <agl-select #rapidUpdatesSelect [options]="rapidOptions" [(ngModel)]="rapidValue" optionLabel="name" placeholder="Rapid updates test" (onChange)="onRapidChange($event)"></agl-select>

            <!-- Memory intensive test -->
            <agl-select #memorySelect [options]="memoryOptions" [(ngModel)]="memoryValue" optionLabel="label" optionValue="value" placeholder="Memory test" [virtualScroll]="true" [scrollHeight]="200"></agl-select>

            <!-- Unicode and special characters -->
            <agl-select #unicodeSelect [options]="unicodeOptions" [(ngModel)]="unicodeValue" optionLabel="text" optionValue="id" placeholder="Unicode test"></agl-select>

            <!-- Circular reference test -->
            <agl-select #circularSelect [options]="circularOptions" [(ngModel)]="circularValue" optionLabel="name" placeholder="Circular test"></agl-select>

            <!-- Null/undefined edge cases -->
            <agl-select #edgeSelect [options]="edgeOptions" [(ngModel)]="edgeValue" [optionLabel]="edgeLabel" [placeholder]="edgePlaceholder"></agl-select>
        </div>
    `
})
...
describe('Select', () => {
    ...
    beforeEach(async () => {
        ...
        selectElement = fixture.debugElement.query(By.css('agl-select'));
    ...
    describe('Accessibility', () => {
        ...
        it('should support autofocus', () => {
            ...
            const autoFocusElement = fixture.debugElement.query(By.css('[aglAutoFocus]')) || fixture.debugElement.query(By.css('[autofocus]')) || fixture.debugElement.query(By.css('input'));
...
describe('Select - Reactive Forms Integration', () => {
    ...
    beforeEach(async () => {
        ...
        component = fixture.componentInstance;
        selectInstance = fixture.debugElement.query(By.css('agl-select')).componentInstance;
        fixture.detectChanges();
    });
...
describe('Select - aglTemplate Content Projection', () => {
...
describe('Select Comprehensive Form Integration', () => {
    ...
    describe('Reactive Forms API', () => {
        ...
        it('should work with updateOn blur', async () => {
            ...
            const blurSelect = formFixture.debugElement.query(By.css('agl-select[formControlName="updateOnBlurSelect"]')).componentInstance;
    ...
    describe('NgModel Integration', () => {
        it('should work with NgModel', async () => {
            const ngModelSelect = formFixture.debugElement.query(By.css('agl-select[name="ngModelSelect"]'));
        ...
        it('should track NgModel status', async () => {
            const ngModelRef = formFixture.debugElement.query(By.css('agl-select[name="ngModelSelect"]'));
...
describe('Select ViewChild Properties', () => {
    ...
    it('should render filter input ViewChild when filter is enabled', async () => {
        ...
        const filterInput = viewChildFixture.debugElement.query(By.css('input[aglInputText]'));
        expect(filterInput).toBeTruthy();
    ...
    it('should render scroller ViewChild for virtual scrolling', async () => {
        ...
        const scroller = viewChildFixture.debugElement.query(By.css('agl-scroller'));
...
describe('Select Complex Edge Cases', () => {
    ...
    describe('Rapid Updates', () => {
        it('should handle rapid option updates', async () => {
            const rapidSelect = edgeFixture.debugElement.query(By.css('agl-select[placeholder="Rapid updates test"]')).componentInstance;
    ...
    describe('Memory Intensive Operations', () => {
        it('should handle large datasets without memory issues', async () => {
            const memorySelect = edgeFixture.debugElement.query(By.css('agl-select[placeholder="Memory test"]')).componentInstance;
    ...
    describe('Unicode and Special Characters', () => {
        it('should handle XSS attempts safely', () => {
            const unicodeSelect = edgeFixture.debugElement.query(By.css('agl-select[placeholder="Unicode test"]')).componentInstance;
    ...
    describe('Circular References', () => {
        it('should handle circular references without infinite loops', async () => {
            const circularSelect = edgeFixture.debugElement.query(By.css('agl-select[placeholder="Circular test"]')).componentInstance;
    ...
    describe('Null/Undefined Edge Cases', () => {
        it('should handle null options gracefully', async () => {
            ...
            const edgeSelect = edgeFixture.debugElement.query(By.css('agl-select[placeholder]:last-child'));
...
describe('Select PT (PassThrough)', () => {
    ...
    describe('Case 9: getPTItemOptions context test', () => {
        ...
        it('should provide complete context object with all properties in getPTItemOptions', async () => {
            ...
            selectInstance.show();
            // The pt callback runs while the option list renders, so the overlay has to have
            // finished opening before the captured contexts are complete. This is one of the
            // few places in this file where the motion genuinely matters.
    ...
    describe('Clear icon and checkmark PT sections', () => {
        it('should apply PT to clear icon when visible', async () => {
            ...
            fixture.detectChanges();
            await waitUntil(() => !!fixture.debugElement.query(By.css('[data-pc-section="clearicon"]')), fixture);
