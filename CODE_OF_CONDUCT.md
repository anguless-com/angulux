...
angulux is a fork of MIT-licensed work by PrimeTek, and it exists alongside other forks of
the same work. Disparagement of PrimeTek, of their commercial licensing decision, or of
other forks and their maintainers is **not welcome here** and will be moderated under this
Code of Conduct.

This is partly principle and partly self-interest. PrimeTek gave the community ten years of
MIT work, and this project is built on that grant. Contempt for upstream is a bad way to
treat that, and it also raises the odds of a trademark dispute that would hurt everyone,
including the other forks. Compare on facts and measurements; do not pick fights.
...
community leaders responsible for enforcement by opening a **private security advisory** at
https://github.com/anguless-com/angulux/security/advisories/new — it is the only private
channel this project has, and it is deliberately used for conduct reports too rather than
...
**Practical note on capacity:** this project has one maintainer. Reports are taken
seriously and acted on, but a same-day response cannot be promised. See
