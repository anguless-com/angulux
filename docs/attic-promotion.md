...
This library ships **64** of PrimeNG's 117 modules. The other **53** are inherited verbatim
...
- **42 of 53** drag nothing, need no external dependency, and arrive with an
...
<!-- Derived by inspecting packages/angulux/attic, not maintained by hand: re-run the survey
     rather than editing this table. Accurate at 22.2.3. See the note beside the evidence
     block in README.md for why a number that cannot be gated is not written in the present
     tense. -->
