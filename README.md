...
Seven gates run on every commit, every pull request, and on a schedule. They do not check
style — each one closes a class of failure that has already happened in this repository.
